...
<tr>
<td valign="top">
<span style=" font-size:18px; font-family:Arial;">${title} Nr.: ${invoiceno} </span>
</td>
...
<#if type!='3'>
<tr style="font-size:13px; font-family:Arial, Helvetica, sans-serif;">
<td align="right" colspan="6" height="13" width="508"><b>zu zahlender Betrag </b></td>
...
<br/> 
Zahlungsmethode: ${paymethod}<br/> 
<#if deliveryDate??>Liefertermin:${deliveryDate}<br/></#if>
<#if remark??>Vermerk:${remark}<br/></#if>
<p>
<span style=" font-size:13px; font-family:Arial;">Diese <#if type!='2'>Rechnung</#if><#if type=='2'>Gutschrift</#if> ist Bestandteil Ihres Auftrags vom ${buytime}.<br/><#if paytime??><#if type!='2'>Ihre Zahlung ist am ${paytime} bei uns eingegangen. Vielen Dank.</#if><#if type=='2'>Die Gutschrift ist am ${paytime} an Sie ausgezahlt worden.</#if></#if>   </span></p>
