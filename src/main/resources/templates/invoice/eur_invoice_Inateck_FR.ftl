<table width="650" style="page-break-before:always">
<tbody>
<tr>
<td valign="top" nowrap="" width="90%"><b><img  width="600" height="900px" src="${attchmentPath}"/></b></td>
</tr>
</tbody>
</table>
...
<tr><td colspan="2" style=" font-size:18px; font-family:Arial;">numéro de commande: ${orderId}</td></tr>
<tr>
<td valign="top">
<span style=" font-size:18px; font-family:Arial;">facture 
numéro: ${invoiceno} </span></td>
<td valign="top" align="right"><span style=" font-size:18px; font-family:Arial;"><#if type!='2'>${buydate}</#if><#if type=='2'>${paytime}</#if></span></td>
</tr>
<tr>
<td colspan="2">
<span style=" font-size:13px; font-family:Arial;"><strong><br/>Mesdames et Messieurs,<br/></strong>
Nous vous remercions assez cordialement de votre ordre et vous calculons comme 
suit:</span></td>
</tr>
<tr>

<td align="right" colspan="2"><span style=" font-size:13px; font-family:Arial;"><b>Numéro de client: ${customerno} / <#if customer_email??>${customer_email}</#if></b></span></td>
</tr>
</tbody></table>
...
<th align="right" width="51"  ><b>Nombre</b></th>
<th align="right" width="73"  ><b>Taux de TVA</b></th>
<th align="right" width="74" ><b>Prix total</b></th>
<th align="right" width="136" ><b>Total</b></th>
</tr>
<tr>
<td colspan="7" height="15" width="646">
<hr size="1"/>
...
<td align="right" colspan="6" height="16" width="508">Total (net)</td>
...
<td valign="top" align="right" colspan="6" height="15" width="508">TVA montant:</td>
...
votre ordre du ${buytime}.<br/><#if type!='2'>Votre paiement est parvenu le ${paytime} à nous. Merci beaucoup.</#if><#if type=='2'>Vous recevrez un remboursement au ${paytime}. Merci beaucoup.</#if>   </span></p>
...
UID:DE281354945<br/>
Nos conditions commerciales générales valent.</small></font></p>
