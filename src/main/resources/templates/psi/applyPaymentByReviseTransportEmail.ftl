		...
		<div style="font: Verdana normal 14px; color: #000;">
			<div class="WordSection1">
				<p class="MsoNormal" style="margin-bottom: 12.0pt">
					<span lang="EN-US">运单修正付款单编号：${payment.paymentNo}<br></span>
					<span lang="EN-US">运单编号：${payment.tranOrderNo}<br></span>
					<span lang="EN-US">申请人：${payment.applyUser.name}<br></span>
					<span lang="EN-US">承运商：${payment.supplier.nikename}<br></span>
					金额：<span lang="EN-US" style="color: red">${payment.currency} ${payment.reviseAmount?string("0.##")}<br></span>
					帐号信息<span lang="EN-US">:<br>${payment.account}<br><br></span>
				...
				<table class="MsoNormalTable" border="0" cellspacing="0"
					...
					<tbody>
						...
						<tr>
							...
							<td	style="border: solid #666666 1.0pt; border-top: none; background: white; padding: 3.0pt 3.0pt 3.0pt 3.0pt">
								<p	class="MsoNormal" align="center" style="text-align: center">
									<span style="font-size: 8.5pt; color: #333333">修正金额</span><span lang="EN-US"	style="font-size: 8.5pt; font-family: &amp; amp; quot; Verdana &amp;amp; quot; ,&amp; amp; quot; sans-serif &amp;amp; quot;; color: #333333"></span>
								</p>
							</td>
							<td	style="border: solid #666666 1.0pt; border-top: none; background: white; padding: 3.0pt 3.0pt 3.0pt 3.0pt">
								<p	class="MsoNormal" align="center" style="text-align: center">
						...
						<tr>
							...
							<td style="border: solid #666666 1.0pt; border-top: none; background: white; padding: 3.0pt 3.0pt 3.0pt 3.0pt">
								<p	class="MsoNormal" align="center" style="text-align: center">
									<span lang="EN-US"	style="font-size: 8.5pt; font-family: &amp; amp; quot; Verdana &amp;amp; quot; ,&amp; amp; quot; sans-serif &amp;amp; quot;; color: #333333">
									${bItem.reviseType}</span>
								</p>
							</td>
							<td style="border: solid #666666 1.0pt; border-top: none; background: white; padding: 3.0pt 3.0pt 3.0pt 3.0pt">
								<p	class="MsoNormal" align="center" style="text-align: center">
									<span lang="EN-US"	style="font-size: 8.5pt; font-family: &amp; amp; quot; Verdana &amp;amp; quot; ,&amp; amp; quot; sans-serif &amp;amp; quot;; color: #333333">
									${bItem.reviseAmount}</span>
								</p>
							</td>
