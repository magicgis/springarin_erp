 ...
 * <br> <B>Output property:</B> <code>ReturnedCombinedPaymentPreferences</code> - Container consisting of the seller's combined payment preferences. These preferences are used to allow Combined Invoice  
 * orders. This container is returned when <b>ShowCombinedPaymentPreferences</b>
 ...
 * calls to manage shipping discounts for Combined Invoice orders.
 * </span>
 * <br> <B>Output property:</B> <code>ReturnedCrossPromotionPreferences</code> - This container is no longer supported as eBay Store Cross Promotions are no
 * longer supported in the Trading API. This container will be removed from the
 * Trading WSDL and API Call Reference docs in a future release.
 * <br><br>
 ...
 * <br> <B>Output property:</B> <code>ReturnedSellerReturnPreferences</code> - Container consisting of the <b>OptedIn</b> flag that indicates whether or not the seller has opted in to eBay Managed Returns. This
 ...
 * <br> <B>Output property:</B> <code>ReturnedDispatchCutoffTimePreference</code> - Contains information about a seller's order cut off time preferences for same day shipping. If the seller specifies a value of <code>0</code> in <strong>Item.DispatchTimeMax</strong> to offer same day handling when listing an item, the seller's shipping time commitment depends on the order cut off time set for the listing site, as indicated by <strong>DispatchCutoffTimePreference.CutoffTime</strong>.
 * <br> <B>Output property:</B> <code>ReturnedGlobalShippingProgramListingPreference</code> - If the <strong>ShowGlobalShippingProgramListingPreference</strong> field is submitted and set to <code>true</code>, this flag is returned. A returned value of <code>true</code> indicates that the seller's new listings will enable the Global Shipping Program by default.
 * <br> <B>Output property:</B> <code>ReturnedOverrideGSPServiceWithIntlServicePreference</code> - If the <strong>ShowOverrideGSPServiceWithIntlServicePreference</strong> field is submitted and set to <code>true</code>, this flag is returned. A returned value of <code>true</code> indicates that for the seller's listings that specify an international shipping service for any Global Shipping-eligible country, the specified service will take precedence and be the listing's default international shipping option for buyers in that country, rather than the Global Shipping Program. 
 * <br/><br/>
 * A returned value of <code>false</code> indicates that the Global Shipping program will take precedence over any international shipping service as the default option in Global Shipping-eligible listings for shipping to any Global Shipping-eligible country.
 * 
 * @author Ron Murphy
