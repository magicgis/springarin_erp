...
public enum InquiryStatusCodeType {
    ...
    /**
     * 
     * 					This value indicates that the shipment tracking request is invalid.
     * 				
     * 
     */
    ...
    /**
     * 
     * 					This value indicates that the shipment tracking request is not applicable.
     * 				
     * 
     */
    ...
    /**
     * 
     * 					This value indicates that the shipment tracking request is pending a response from the  buyer.
     * 				
     * 
     */
    ...
    /**
     * 
     * 					This value indicates that the shipment tracking request is pending a response from the  seller.
     * 				
     * 
     */
    ...
    /**
     * 
     * 					This value indicates that a shipment tracking request was closed with a refund issued to the buyer.
     * 				
     * 
     */
    ...
    /**
     * 
     * 					This value indicates that a shipment tracking request was closed with no refund issued to the buyer.
     * 				
     * 
     */
    ...
    /**
     * 
     * 					This value indicates that a shipment tracking request was escalated to an eBay Buyer Protection case, and it is pending a response from the buyer.
     * 				
     * 
     */
    ...
    /**
     * 
     * 					This value indicates that a shipment tracking request was escalated to an eBay Buyer Protection case, and it is pending a response from eBay Customer Support.
     * 				
     * 
     */
    ...
    /**
     * 
     * 					This value indicates that a shipment tracking request was escalated to an eBay Buyer Protection case, but it was closed with a refund issued to the buyer.
     * 				
     * 
     */
    ...
    /**
     * 
     * 					This value indicates that a shipment tracking request was escalated to an eBay Buyer Protection case, but it was closed with no refund issued to the buyer.
     * 				
     * 
     */
