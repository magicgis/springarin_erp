...
public enum CancelReasonCodeType {
    ...
    /**
     * 
     * 							This value indicates that the eBay Now order was cancelled because the buyer placed the order by mistake.
     * 						
     * 
     */
    ...
    /**
     * 
     * 							This value indicates that the eBay Now order was cancelled because the buyer decided that the price for the item was too high.
     * 						
     * 
     */
    ...
    /**
     * 
     * 							This value indicates that the eBay Now order was cancelled because the buyer found the same item somewhere else at a cheaper price.
     * 					        
     * 
     */
    ...
    /**
     * 
     * 							This value indicates that the eBay Now order was cancelled because the buyer realized that the order will not arrive within the expected delivery time.
     * 					        
     * 
     */
