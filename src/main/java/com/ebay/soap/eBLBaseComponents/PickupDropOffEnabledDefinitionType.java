 ...
 * 				<br/><br/>
 * 				Currently, the "Click and Collect" feature is only available on the eBay UK site (site ID=3).
 * 				<br/><br/>
 * 				To verify if a specific category on the eBay UK site supports the the "Click and Collect" feature, pass in a <b>CategoryID</b> value in the request, and then look for a 'true' value in the <b>PickupDropOffEnabled</b> field of the corresponding Category node (match up the <b>CategoryID</b> values if more than one Category IDs were passed in the request). 
 * 			
 * 
