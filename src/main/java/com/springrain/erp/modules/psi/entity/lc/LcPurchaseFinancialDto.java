...
@Entity
@Table(name = "lc_psi_purchase_financial_report")
public class LcPurchaseFinancialDto implements Serializable {
	...
	public LcPurchaseFinancialDto(){};
	
	public LcPurchaseFinancialDto(String month,Integer supplierId, String productNameColor,Float orderAmount, Float payOrderAmount, Float payLadingAmount,Date dataDate) {
		super();
		this.month= month;
		this.supplierId = supplierId;
		this.productNameColor = productNameColor;
