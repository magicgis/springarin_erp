 ...
 */
@Entity
@Table(name = "lc_psi_transport_order_item")
@Cache(usage = CacheConcurrencyStrategy.NONE)
public class LcPsiTransportOrderItem implements Comparable<LcPsiTransportOrderItem>{
	...
	private     Float               lowerPrice;         //出口价格
	private     Float               importPrice;        //进口价格
	private     LcPsiTransportOrder   transportOrder;     //运单,
	...
	private  List<PsiVatInvoiceUseInfo> invoices;
	...
	public List<PsiVatInvoiceUseInfo> getInvoices() {
		return invoices;
	}

	public void setInvoices(List<PsiVatInvoiceUseInfo> invoices) {
	...
	@Transient 
    public BigDecimal getTempTotalPrice() {
		return tempTotalPrice;
	}

	public void setTempTotalPrice(BigDecimal tempTotalPrice) {
	...
	public LcPsiTransportOrderItem() {
		super();
	}

	public LcPsiTransportOrderItem(Integer id){
		this();
		this.id = id;
	}
	...
	@NotFound(action = NotFoundAction.IGNORE)
	public LcPsiTransportOrder getTransportOrder() {
		return transportOrder;
	}

	public void setTransportOrder(LcPsiTransportOrder transportOrder) {
	...
	public String toString(){
		Integer boxNum = (int)Math.floor((this.receiveQuantity==null?this.quantity:this.receiveQuantity)/(double)this.packQuantity);
	...
	@Override
	public int compareTo(LcPsiTransportOrderItem orderItem) {
		// TODO Auto-generated method stub
		return (this.product.getChineseName().concat(StringUtils.isBlank(product.getMaterial())?"":product.getMaterial())).compareTo((orderItem.getProduct().getChineseName().concat(StringUtils.isBlank(orderItem.getProduct().getMaterial())?"":orderItem.getProduct().getMaterial())));
	}
   ...
   @Override public int hashCode() {
	...
	public LcPsiTransportOrderItem(LcPsiTransportOrder transportOrder,PsiProduct product,
