 ...
 */
@Entity
@Table(name = "lc_psi_parts_order_item")
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
public class LcPsiPartsOrderItem implements Serializable{
	private static final long serialVersionUID = -2286755252500449047L;
	...
	private     LcPsiPartsOrder   partsOrder;  	 	// 配件订单
	...
	private List<LcPsiPartsDeliveryItem>  deliveryItemList = Lists.newArrayList();
	...
	@NotFound(action = NotFoundAction.IGNORE)
	public List<LcPsiPartsDeliveryItem> getDeliveryItemList() {
		return deliveryItemList;
	}
	public void setDeliveryItemList(List<LcPsiPartsDeliveryItem> deliveryItemList) {
	...
	@NotFound(action = NotFoundAction.IGNORE)
	public LcPsiPartsOrder getPartsOrder() {
		return partsOrder;
	}
	public void setPartsOrder(LcPsiPartsOrder partsOrder) {
