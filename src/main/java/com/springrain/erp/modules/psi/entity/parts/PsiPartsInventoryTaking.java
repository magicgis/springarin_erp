 ...
 */
@Entity
@Table(name = "psi_parts_inventory_taking")
@Cache(usage = CacheConcurrencyStrategy.NONE)
public class PsiPartsInventoryTaking implements Serializable{
	...
	private      List<PsiPartsInventoryTakingItem>  items = Lists.newArrayList();

	public PsiPartsInventoryTaking() {
		super();
	}

	public PsiPartsInventoryTaking(Integer id){
		this();
		this.id = id;
	}
	...
	public List<PsiPartsInventoryTakingItem> getItems() {
		return items;
	}

	public void setItems(List<PsiPartsInventoryTakingItem> items) {
		this.items = items;
	}
