 ...
 */
@Entity
@Table(name = "lc_psi_transport_revise_item")
@Cache(usage = CacheConcurrencyStrategy.NONE)
public class LcPsiTransportReviseItem {
	...
	private     LcPsiTransportRevise transportRevise; 
	

	public LcPsiTransportReviseItem() {
		super();
	}

	public LcPsiTransportReviseItem(Integer id){
		this();
		this.id = id;
	}
	...
	public LcPsiTransportRevise getTransportRevise() {
		return transportRevise;
	}

	public void setTransportRevise(LcPsiTransportRevise transportRevise) {
