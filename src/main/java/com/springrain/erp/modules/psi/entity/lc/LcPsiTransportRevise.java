 ...
 */
@Entity
@Table(name = "lc_psi_transport_revise")
@Cache(usage = CacheConcurrencyStrategy.NONE)
public class LcPsiTransportRevise {
	...
	private      List<LcPsiTransportReviseItem> items;
	...
	public LcPsiTransportRevise() {
		super();
	}

	public LcPsiTransportRevise(Integer id){
		this();
		this.id = id;
	}
	...
	public List<LcPsiTransportReviseItem> getItems() {
		return items;
	}

	public void setItems(List<LcPsiTransportReviseItem> items) {
		this.items = items;
	}
	...
	public  Float getTotalAmount(){
		...
		for(LcPsiTransportReviseItem item:this.items){
