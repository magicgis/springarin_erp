 ...
 */
@Entity
@Table(name = "lc_psi_parts_inventory_out_item")
@Cache(usage = CacheConcurrencyStrategy.NONE)
public class LcPsiPartsInventoryOutItem implements Serializable{
	...
	public LcPsiPartsInventoryOutItem() {
		super();
	}

	public LcPsiPartsInventoryOutItem(Integer id){
		this();
		this.id = id;
	}
	
	public LcPsiPartsInventoryOutItem(Integer partsId, String partsName,Integer mixtureRatio,Integer stockQuantity,Integer maxCanQuantity) {
		super();
