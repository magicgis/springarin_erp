 ...
 */
@Entity
@Table(name = "psiPartsDeliveryItem")
@Cache(usage = CacheConcurrencyStrategy.NONE)
public class PsiPartsDeliveryItem implements Serializable{
	...
	private 	PsiPartsDelivery	 partsDelivery;
	private 	PsiPartsOrderItem    partsOrderItem;      
	
	public PsiPartsDeliveryItem() {
		super();
	}

	public PsiPartsDeliveryItem(Integer id){
		this();
		this.id = id;
	}
	...
	public PsiPartsDelivery getPartsDelivery() {
		return partsDelivery;
	}
	public void setPartsDelivery(PsiPartsDelivery partsDelivery) {
	...
	@NotFound(action = NotFoundAction.IGNORE)
	public PsiPartsOrderItem getPartsOrderItem() {
		return partsOrderItem;
	}
	public void setPartsOrderItem(PsiPartsOrderItem partsOrderItem) {
