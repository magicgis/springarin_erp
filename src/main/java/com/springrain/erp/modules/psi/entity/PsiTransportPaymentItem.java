 ...
 */
@Entity
@Table(name = "psi_transport_payment_item")
@Cache(usage = CacheConcurrencyStrategy.NONE)
public class PsiTransportPaymentItem{
	
	private 	Integer 			id; 		      // id
	private     PsiTransportPayment transportPayment; // 运单付款总表
	...
	public PsiTransportPaymentItem() {
		super();
	}

	public PsiTransportPaymentItem(Integer id){
		this();
		this.id = id;
	}
	...
	public PsiTransportPayment getTransportPayment() {
		return transportPayment;
	}

	public void setTransportPayment(PsiTransportPayment transportPayment) {
