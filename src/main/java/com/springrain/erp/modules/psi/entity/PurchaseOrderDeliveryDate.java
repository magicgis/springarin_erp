...
@Entity
@Table(name = "psi_purchase_order_delivery_date")
public class PurchaseOrderDeliveryDate  implements Serializable{
	...
	private     PurchaseOrderItem orderItem;                     // 采购订单项
	...
	public PurchaseOrderDeliveryDate(){};
	
	public PurchaseOrderDeliveryDate(Integer productId,String productName,String colorCode,String countryCode,Date deliveryDate,
			Integer quantity,Integer quantityReceived,PurchaseOrderItem orderItem,String delFlag,Integer purchaseOrderId,
