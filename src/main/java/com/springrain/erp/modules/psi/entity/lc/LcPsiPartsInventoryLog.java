 ...
 */
@Entity
@Table(name = "lc_psi_parts_inventory_log")
@Cache(usage = CacheConcurrencyStrategy.NONE)
public class LcPsiPartsInventoryLog implements Serializable{
	...
	public LcPsiPartsInventoryLog() {
		super();
	}

	public LcPsiPartsInventoryLog(Integer id){
		this();
		this.id = id;
	}
	...
	public LcPsiPartsInventoryLog(Integer partsId, String partsName,Integer quantity, String dataType, String relativeNumber,	User createUser, Date createDate, String operateType, String remark) {
		super();
		this.partsId = partsId;
		this.partsName = partsName;
		this.quantity = quantity;
