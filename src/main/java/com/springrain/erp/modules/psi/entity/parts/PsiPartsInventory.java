 ...
 */
@Entity
@Table(name = "psi_parts_inventory")
@Cache(usage = CacheConcurrencyStrategy.NONE)
public class PsiPartsInventory{
	...
	private     List<PsiPartsInventoryLog> partsLogs ; // 日志list (非数据库字段)

	public PsiPartsInventory() {
		super();
	}

	public PsiPartsInventory(Integer id){
		this();
		this.id = id;
	}
	...
	@Transient
	public List<PsiPartsInventoryLog> getPartsLogs() {
		return partsLogs;
	}

	public void setPartsLogs(List<PsiPartsInventoryLog> partsLogs) {
