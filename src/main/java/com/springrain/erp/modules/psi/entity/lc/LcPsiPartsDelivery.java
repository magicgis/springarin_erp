 ...
 */
@Entity
@Table(name = "lc_psi_parts_delivery")
@Cache(usage = CacheConcurrencyStrategy.NONE)
public class LcPsiPartsDelivery implements Serializable {
	...
	private 	List<LcPsiPartsDeliveryItem>     items = Lists.newArrayList() ;
	private 	List<LcPsiPartsPaymentItem>      payItems;  
	
	private 	String          oldItemIds;
	
	public LcPsiPartsDelivery() {
		super();
	}

	public LcPsiPartsDelivery(Integer id){
		this();
		this.id = id;
	}
	
	public LcPsiPartsDelivery(Integer id,String billNo,Float totalAmount,Float totalPaymentAmount,String currencyType){
		super();
		this.id = id;
		this.billNo=billNo;
	...
	public List<LcPsiPartsPaymentItem> getPayItems() {
		return payItems;
	}

	public void setPayItems(List<LcPsiPartsPaymentItem> payItems) {
	...
	public Integer getLadingTotal(){
		...
		for(LcPsiPartsDeliveryItem item:items){
	...
	public List<LcPsiPartsDeliveryItem> getItems() {
		return items;
	}
	public void setItems(List<LcPsiPartsDeliveryItem> items) {
		this.items = items;
	}
