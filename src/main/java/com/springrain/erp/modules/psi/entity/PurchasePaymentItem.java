 ...
 */
@Entity
@Table(name = "psi_purchase_payment_item")
@Cache(usage = CacheConcurrencyStrategy.NONE)
public class PurchasePaymentItem implements Serializable {
	private static final long serialVersionUID = 3730126938966032051L;
	private    Integer      	id; 		       
	private    PurchaseOrder 	order;
	private    PsiLadingBill 	ladingBill;
	...
	private    PsiLadingBillItem 	ladingBillItem;
	
	
	
	public PurchasePaymentItem() {
		super();
	}
	public PurchasePaymentItem(Integer id){
		this();
		this.id = id;
	}
	...
	@NotFound(action = NotFoundAction.IGNORE)
	public PsiLadingBillItem getLadingBillItem(){
		return ladingBillItem;
	}
	
	public void setLadingBillItem(PsiLadingBillItem ladingBillItem){
	...
	public BigDecimal getPaymentAmountTotal() {
		if("0".equals(paymentType)){
			...
			return ladingBillItem.getTotalAmount();
		}
	}
	...
	public String getUrl() {
		if("0".equals(paymentType)){
			return "<a href='"+BaseService.BASE_WEBPATH+Global.getAdminPath()+"/psi/purchaseOrder/view?id="+order.getId()+"'>"+billNo+"</a>";
		}else{
			return "<a href='"+BaseService.BASE_WEBPATH+Global.getAdminPath()+"/psi/psiLadingBill/view?id="+ladingBill.getId()+"'>"+billNo+"</a>";
		}
	}
