 ...
 */
@Entity
@Table(name = "psi_transport_payment")
@Cache(usage = CacheConcurrencyStrategy.NONE)
public class PsiTransportPayment {
	...
	private     List<PsiTransportPaymentItem> items;
	
	
	public PsiTransportPayment() {
		super();
	}

	public PsiTransportPayment(Integer id){
		this();
		this.id = id;
	}
	...
	public List<PsiTransportPaymentItem> getItems() {
		return items;
	}

	public void setItems(List<PsiTransportPaymentItem> items) {
		this.items = items;
	}
