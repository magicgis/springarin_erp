 ...
 */
@Entity
@Table(name = "psi_parts_inventory_taking_item")
@Cache(usage = CacheConcurrencyStrategy.NONE)
public class PsiPartsInventoryTakingItem implements Serializable{
	...
	private   PsiPartsInventoryTaking partsTaking;  //主表

	public PsiPartsInventoryTakingItem() {
		super();
	}

	public PsiPartsInventoryTakingItem(Integer id){
		this();
		this.id = id;
	}
	...
	public PsiPartsInventoryTaking getPartsTaking() {
		return partsTaking;
	}

	public void setPartsTaking(PsiPartsInventoryTaking partsTaking) {
