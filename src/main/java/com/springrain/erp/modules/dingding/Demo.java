...
import com.springrain.erp.modules.dingding.auth.AuthHelper;
import com.springrain.erp.modules.dingding.department.DepartmentHelper;
import com.springrain.erp.modules.dingding.eventchange.eventChangeHelper;
import com.springrain.erp.modules.dingding.user.UserHelper;
...
public class Demo {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            String t5="org_admin_add ";
            List<String> callBackTag = new ArrayList<String>();
            callBackTag.add(t1);
            callBackTag.add(t2);
            callBackTag.add(t3);
            callBackTag.add(t4);
            String callBackUrl = "http://47.98.133.34:8080/dingding/eventreceive";//后台接受的回调地址，即上方代码
            try {
                JSONObject s = eventChangeHelper.updateEventChange(accessToken, callBackTag, Env.TOKEN, Env.ENCODING_AES_KEY, callBackUrl);
//                String s = eventChangeHelper.getFailedResult(accessToken);
