...
public class Leave extends IdEntity<Leave> {
	...
	private Integer applyDay;	//申请天数
	private Float applyHour; //申请小时数	小于8
	private Integer realityDay;	//申请天数
	private Float realityHour; //申请小时数	小于8
	...
	public Float getApplyHour() {
		return applyHour;
	}

	public void setApplyHour(Float applyHour) {
		this.applyHour = applyHour;
	}

	public Integer getRealityDay() {
		return realityDay;
	}

	public void setRealityDay(Integer realityDay) {
		this.realityDay = realityDay;
	}

	public Float getRealityHour() {
		return realityHour;
	}

	public void setRealityHour(Float realityHour) {
		this.realityHour = realityHour;
	}
