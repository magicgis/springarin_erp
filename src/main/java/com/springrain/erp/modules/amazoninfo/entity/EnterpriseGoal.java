...
@Entity
@Table(name = "amazoninfo_enterprise_goal")
public class EnterpriseGoal {
	private Integer id;
	private String month;
	private PsiProductTypeGroupDict productLine;
	...
	public PsiProductTypeGroupDict getProductLine() {
		return productLine;
	}

	public void setProductLine(PsiProductTypeGroupDict productLine) {
