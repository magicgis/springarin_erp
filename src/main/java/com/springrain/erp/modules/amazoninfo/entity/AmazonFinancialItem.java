...
@Entity
@Table(name = "amazoninfo_financial_item")
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
public class AmazonFinancialItem {
	private Integer id;
	...
	public AmazonFinancial getOrder() {
		return order;
	}

	public void setOrder(AmazonFinancial order) {
		this.order = order;
	}
