...
import com.springrain.erp.common.workflow.Variable;
import com.springrain.erp.common.workflow.WorkflowEntity;
import com.springrain.erp.common.workflow.WorkflowUtils;
import com.springrain.erp.modules.sys.entity.User;
import com.springrain.erp.modules.sys.service.workflow.WorkflowProcessDefinitionService;
import com.springrain.erp.modules.sys.service.workflow.WorkflowTraceService;
...
public class WorkflowController {
	...
	public String processMap(String processInstanceId, Model model) throws Exception {
		...
		List<ActivityImpl> skips = new ArrayList<ActivityImpl>();
		...
		for (String activeId : activeActivityIds) {
		 ...
		 ProcessDefinitionEntity definition = managementService.executeCommand(new GetDeploymentProcessDefinitionCmd(
                processDefinitionId));
                ...
                if (historicActivityInstance.getEndTime()==null) {
                    ...
                    if (taskId != null) {
                    	...
                    	if(list!=null && list.size()>0){
                    		comment = list.get(0).getFullMessage();
                    	}
                    }
                    // 节点已经结束
                    if ("自动跳过".equals(comment)) {
                    	skips.add(activity);
                    } 
                }
            }
	...
	public String form() {
		return "modules/sys/processForm";
	}
}
