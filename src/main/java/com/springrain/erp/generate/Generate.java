 ...
 */
package com.springrain.erp.generate;
...
public class Generate {
	...
	public static void main(String[] args) throws Exception {
		...
		String packageName = "com.springrain.erp.modules";
		
		String moduleName = "psi";			        // 模块名，例：sys
		String subModuleName = "";				    // 子模块名（可选） 
		String className = "psiLadingBill";			// 类名，例：user
		String classAuthor = "Michael";	        	// 类作者，例：ThinkGem
		String functionName = "提单明细";			    // 功能名，例：用户
		...
		// 模板文件路径
		String tplPath = StringUtils.replace(projectPath+"/src/main/java/com/springrain/erp/generate/template", "/", separator);
