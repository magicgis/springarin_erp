...
public class SalesOrderCreditmemoEntity  implements java.io.Serializable {
    ...
    private com.springrain.magento.SalesOrderCreditmemoItemEntity[] items;

    private com.springrain.magento.SalesOrderCreditmemoCommentEntity[] comments;
    ...
    public SalesOrderCreditmemoEntity(
           ...
           com.springrain.magento.SalesOrderCreditmemoItemEntity[] items,
           com.springrain.magento.SalesOrderCreditmemoCommentEntity[] comments) {
     ...
     * @return items
     */
    public com.springrain.magento.SalesOrderCreditmemoItemEntity[] getItems() {
        return items;
    }
     ...
     * @param items
     */
    public void setItems(com.springrain.magento.SalesOrderCreditmemoItemEntity[] items) {
        this.items = items;
    }
     ...
     * @return comments
     */
    public com.springrain.magento.SalesOrderCreditmemoCommentEntity[] getComments() {
        return comments;
    }
     ...
     * @param comments
     */
    public void setComments(com.springrain.magento.SalesOrderCreditmemoCommentEntity[] comments) {
        this.comments = comments;
    }
