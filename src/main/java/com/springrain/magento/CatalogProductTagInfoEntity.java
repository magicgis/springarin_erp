...
public class CatalogProductTagInfoEntity  implements java.io.Serializable {
    ...
    private com.springrain.magento.AssociativeEntity[] products;
    ...
    public CatalogProductTagInfoEntity(
           ...
           com.springrain.magento.AssociativeEntity[] products) {
           this.name = name;
           this.status = status;
     ...
     * @return products
     */
    public com.springrain.magento.AssociativeEntity[] getProducts() {
        return products;
    }
     ...
     * @param products
     */
    public void setProducts(com.springrain.magento.AssociativeEntity[] products) {
        this.products = products;
    }
