...
public class MagentoServiceLocator extends org.apache.axis.client.Service implements com.springrain.magento.MagentoService {
    ...
    private java.lang.String Port_address = "http://www.inatecktest.com/index.php/api/v2_soap/index/";
    ...
    public com.springrain.magento.PortType getPort() throws javax.xml.rpc.ServiceException {
    ...
    public com.springrain.magento.PortType getPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.springrain.magento.BindingStub _stub = new com.springrain.magento.BindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.springrain.magento.PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.springrain.magento.BindingStub _stub = new com.springrain.magento.BindingStub(new java.net.URL(Port_address), this);
                _stub.setPortName(getPortWSDDServiceName());
                return _stub;
            }
        }
