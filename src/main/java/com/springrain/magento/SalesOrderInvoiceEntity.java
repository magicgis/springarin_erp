...
public class SalesOrderInvoiceEntity  implements java.io.Serializable {
    ...
    private com.springrain.magento.SalesOrderInvoiceItemEntity[] items;

    private com.springrain.magento.SalesOrderInvoiceCommentEntity[] comments;
    ...
    public SalesOrderInvoiceEntity(
           ...
           com.springrain.magento.SalesOrderInvoiceItemEntity[] items,
           com.springrain.magento.SalesOrderInvoiceCommentEntity[] comments) {
     ...
     * @return items
     */
    public com.springrain.magento.SalesOrderInvoiceItemEntity[] getItems() {
        return items;
    }
     ...
     * @param items
     */
    public void setItems(com.springrain.magento.SalesOrderInvoiceItemEntity[] items) {
        this.items = items;
    }
     ...
     * @return comments
     */
    public com.springrain.magento.SalesOrderInvoiceCommentEntity[] getComments() {
        return comments;
    }
     ...
     * @param comments
     */
    public void setComments(com.springrain.magento.SalesOrderInvoiceCommentEntity[] comments) {
        this.comments = comments;
    }
