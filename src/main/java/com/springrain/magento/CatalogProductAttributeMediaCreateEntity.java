...
public class CatalogProductAttributeMediaCreateEntity  implements java.io.Serializable {
    private com.springrain.magento.CatalogProductImageFileEntity file;
    ...
    public CatalogProductAttributeMediaCreateEntity(
           com.springrain.magento.CatalogProductImageFileEntity file,
     ...
     * @return file
     */
    public com.springrain.magento.CatalogProductImageFileEntity getFile() {
        return file;
    }
     ...
     * @param file
     */
    public void setFile(com.springrain.magento.CatalogProductImageFileEntity file) {
        this.file = file;
    }
