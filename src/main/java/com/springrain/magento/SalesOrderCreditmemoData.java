...
public class SalesOrderCreditmemoData  implements java.io.Serializable {
    private com.springrain.magento.OrderItemIdQty[] qtys;
    ...
    public SalesOrderCreditmemoData(
           com.springrain.magento.OrderItemIdQty[] qtys,
     ...
     * @return qtys
     */
    public com.springrain.magento.OrderItemIdQty[] getQtys() {
        return qtys;
    }
     ...
     * @param qtys
     */
    public void setQtys(com.springrain.magento.OrderItemIdQty[] qtys) {
        this.qtys = qtys;
    }
