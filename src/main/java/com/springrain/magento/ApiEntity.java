...
public class ApiEntity  implements java.io.Serializable {
    ...
    private com.springrain.magento.ApiMethodEntity[] methods;
    ...
    public ApiEntity(
           ...
           com.springrain.magento.ApiMethodEntity[] methods) {
           this.title = title;
           this.name = name;
     ...
     * @return methods
     */
    public com.springrain.magento.ApiMethodEntity[] getMethods() {
        return methods;
    }
     ...
     * @param methods
     */
    public void setMethods(com.springrain.magento.ApiMethodEntity[] methods) {
        this.methods = methods;
    }
