...
public class Filters  implements java.io.Serializable {
    private com.springrain.magento.AssociativeEntity[] filter;

    private com.springrain.magento.ComplexFilter[] complex_filter;

    public Filters() {
    }

    public Filters(
           com.springrain.magento.AssociativeEntity[] filter,
           com.springrain.magento.ComplexFilter[] complex_filter) {
           this.filter = filter;
     ...
     * @return filter
     */
    public com.springrain.magento.AssociativeEntity[] getFilter() {
        return filter;
    }
     ...
     * @param filter
     */
    public void setFilter(com.springrain.magento.AssociativeEntity[] filter) {
        this.filter = filter;
    }
     ...
     */
    public com.springrain.magento.ComplexFilter[] getComplex_filter() {
        return complex_filter;
    }
     ...
     */
    public void setComplex_filter(com.springrain.magento.ComplexFilter[] complex_filter) {
        this.complex_filter = complex_filter;
    }
