...
public class CatalogProductDownloadableLinkInfoEntity  implements java.io.Serializable {
    private com.springrain.magento.CatalogProductDownloadableLinkEntity[] links;

    private com.springrain.magento.CatalogProductDownloadableLinkSampleEntity[] samples;

    public CatalogProductDownloadableLinkInfoEntity() {
    }

    public CatalogProductDownloadableLinkInfoEntity(
           com.springrain.magento.CatalogProductDownloadableLinkEntity[] links,
           com.springrain.magento.CatalogProductDownloadableLinkSampleEntity[] samples) {
           this.links = links;
     ...
     * @return links
     */
    public com.springrain.magento.CatalogProductDownloadableLinkEntity[] getLinks() {
        return links;
    }
     ...
     * @param links
     */
    public void setLinks(com.springrain.magento.CatalogProductDownloadableLinkEntity[] links) {
        this.links = links;
    }
     ...
     * @return samples
     */
    public com.springrain.magento.CatalogProductDownloadableLinkSampleEntity[] getSamples() {
        return samples;
    }
     ...
     * @param samples
     */
    public void setSamples(com.springrain.magento.CatalogProductDownloadableLinkSampleEntity[] samples) {
        this.samples = samples;
    }
