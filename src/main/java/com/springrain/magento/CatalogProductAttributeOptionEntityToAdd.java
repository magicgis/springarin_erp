...
public class CatalogProductAttributeOptionEntityToAdd  implements java.io.Serializable {
    private com.springrain.magento.CatalogProductAttributeOptionLabelEntity[] label;
    ...
    public CatalogProductAttributeOptionEntityToAdd(
           com.springrain.magento.CatalogProductAttributeOptionLabelEntity[] label,
           int order,
           int is_default) {
           this.label = label;
           this.order = order;
     ...
     * @return label
     */
    public com.springrain.magento.CatalogProductAttributeOptionLabelEntity[] getLabel() {
        return label;
    }
     ...
     * @param label
     */
    public void setLabel(com.springrain.magento.CatalogProductAttributeOptionLabelEntity[] label) {
        this.label = label;
    }
