...
public class GiftMessageAssociativeProductsEntity  implements java.io.Serializable {
    private com.springrain.magento.ShoppingCartProductEntity product;

    private com.springrain.magento.GiftMessageEntity message;

    public GiftMessageAssociativeProductsEntity() {
    }

    public GiftMessageAssociativeProductsEntity(
           com.springrain.magento.ShoppingCartProductEntity product,
           com.springrain.magento.GiftMessageEntity message) {
     ...
     * @return product
     */
    public com.springrain.magento.ShoppingCartProductEntity getProduct() {
        return product;
    }
     ...
     * @param product
     */
    public void setProduct(com.springrain.magento.ShoppingCartProductEntity product) {
        this.product = product;
    }
     ...
     * @return message
     */
    public com.springrain.magento.GiftMessageEntity getMessage() {
        return message;
    }
     ...
     * @param message
     */
    public void setMessage(com.springrain.magento.GiftMessageEntity message) {
        this.message = message;
    }
