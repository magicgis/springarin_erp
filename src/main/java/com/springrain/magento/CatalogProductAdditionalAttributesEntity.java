...
public class CatalogProductAdditionalAttributesEntity  implements java.io.Serializable {
    private com.springrain.magento.AssociativeMultiEntity[] multi_data;

    private com.springrain.magento.AssociativeEntity[] single_data;

    public CatalogProductAdditionalAttributesEntity() {
    }

    public CatalogProductAdditionalAttributesEntity(
           com.springrain.magento.AssociativeMultiEntity[] multi_data,
           com.springrain.magento.AssociativeEntity[] single_data) {
     ...
     * @return multi_data
     */
    public com.springrain.magento.AssociativeMultiEntity[] getMulti_data() {
        return multi_data;
    }
     ...
     * @param multi_data
     */
    public void setMulti_data(com.springrain.magento.AssociativeMultiEntity[] multi_data) {
        this.multi_data = multi_data;
    }
     ...
     * @return single_data
     */
    public com.springrain.magento.AssociativeEntity[] getSingle_data() {
        return single_data;
    }
     ...
     * @param single_data
     */
    public void setSingle_data(com.springrain.magento.AssociativeEntity[] single_data) {
        this.single_data = single_data;
    }
