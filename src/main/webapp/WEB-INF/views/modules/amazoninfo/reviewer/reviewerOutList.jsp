...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a class="typeHref" href="#" key="1">站外客户</a></li>
	</ul>
	<ul class="nav nav-tabs">
		...
		<c:forEach items="${page.list}" var="reviewer">
			<tr>
				...
				<td>
					...
					<a class="btn btn-warning btn-small" href="${ctx}/amazoninfo/reviewer/records?id=${reviewer.id}">联系记录</a>
					<a class="btn btn-success btn-small" href="${ctx}/amazoninfo/reviewer/sendEmail?email=${reviewer.reviewEmail}">发送邮件</a>
				</td>
			</tr>
		</c:forEach>
		</tbody>
