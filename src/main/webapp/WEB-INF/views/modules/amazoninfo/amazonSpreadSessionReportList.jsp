...
<%@ include file="/WEB-INF/views/include/taglib.jsp"%>
	<div style="width: 550px;border:1px solid #ccc">
		<div id="${country}${asin}" style="height:260px"></div>
	</div>
	<script type="text/javascript">
	    ...
	    require(
	        ...
	        function(ec) {
	            myChart = ec.init(document.getElementById('${country}${asin}'));
	            myChart.showLoading({
	                ...
	                series : [
						{
						      name:'${productName}',
						      type:'line',
						      data:[<c:forEach items="${xAxis}" var="x" varStatus="i">${empty sessionMap[x]?0:sessionMap[x]}${i.last?'':','}</c:forEach>]
						  }
	                ]
	            };
