		...
		$(document).ready(function() {
			...
			$("#btnCancel").click(function(){
		     ...
		     $("#salesChannel").change(function(){
		    	 var params = {};
		    	 params.id=$("#id").val();
		    	 params['salesChannel.id']=$(this).val();
		    	 window.location.href = "${ctx}/amazoninfo/unlineOrder/edit?"+$.param(params);
		     });
...
<br/>
	...
	<form:form id="inputForm" modelAttribute="amazonUnlineOrder"  action="${ctx}/amazoninfo/unlineOrder/saveAdd" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input maxlength="255" class="required" path="buyerName" id="buyerName" readonly="true" />
			</div>
		</div>
		</td><td>
		<div class="control-group">
			...
			<div class="controls">
				<form:input maxlength="255" class="email required" path="buyerEmail" id="buyerEmail" readonly="true"/>
			</div>
		</div>
		</td>
		</tr>
			 	 	...
			 	 	<tr>
			 	  		<td >
						 	<div class="control-group">
									...
									<div class="controls">
										<form:input maxlength="255" class="required" path="shippingAddress.name" id="shippingAddress.name" readonly="true"/>
									</div>
							</div>
			 	 		 </td>
			 	 		 <td >
							<div class = "control-group">
									...
									<div class="controls">
										<form:input maxlength="255"  path="shippingAddress.phone" id="shippingAddress.phone" readonly="true"/>
									</div>
							</div>
			   		 ...
			   		 <tr>
							...
							<div class="control-group">
								...
								<div class="controls">
									<form:input maxlength="255" class="required" path="shippingAddress.postalCode" id="shippingAddress.postalCode" readonly="true"/>
								</div>
							</div>
			   		 	</td>
			   		 	<td >
							<div class="control-group">
								...
								<div class="controls">
									<form:input maxlength="255" class="required" path="shippingAddress.countryCode" id="shippingAddress.countryCode" readonly="true"/>
								</div>
							</div>
			   		 ...
			   		 <table>
			   		  ...
			   		  <tr>
							...
							<div class="control-group">
								...
								<div class="controls">
									<form:input maxlength="255" class="span3" path="shippingAddress.stateOrRegion" id="shippingAddress.stateOrRegion" readonly="true"/>
								</div>
							</div>
			   		 	</td>
			   		 	<td >
							<div class="control-group">
								...
								<div class="controls">
									<form:input maxlength="255" class="span3" path="shippingAddress.city" id="shippingAddress.city" readonly="true"/>
								</div>
							</div>
			   		 	...
			   		 	<td>
			     		 	<div class="control-group">
								...
								<div class="controls">
									<form:input maxlength="255"  class="span2" path="shippingAddress.county" id="shippingAddress.county" readonly="true"/>
								</div>
							</div>
			   		 	</td>
			   		 </tr>
			   		 <tr>
							...
							<div class="control-group">
								...
								<div class="controls">
										<form:input maxlength="255" class="required" path="shippingAddress.addressLine1" id="shippingAddress.addressLine1" readonly="true"/>
								</div>
							</div>
			   		 	</td>
			   		 	<td>
							<div class="control-group">
								...
								<div class="controls" >
									<form:input maxlength="255" class="span3"  path="shippingAddress.addressLine2" id="shippingAddress.addressLine2" readonly="true"/>
								</div>
							</div>	
			   		 	</td>
			   		 	<td>  
							<div class="control-group">
								...
								<div class="controls">
									<form:input class="span2" maxlength="255" path="shippingAddress.addressLine3" id="shippingAddress.addressLine3" readonly="true"/>
								</div>
							</div>		
			   		 	</td>
			   		 </tr>
	 ...
	 <table>
		...
		<thead>
			<tr>
			     <c:if test="${'管理员' eq amazonUnlineOrder.orderChannel}">
			      <th style="width: 6%">Asin</th>
			     </c:if> 
				  <th style="width: 25%"><spring:message code="amazon_order_form20"/></th>
				   <th style="width: 8%"><spring:message code="amazon_order_form23"/></th>
				  <%--  <th style="width: 10%"><spring:message code="amazon_order_form7"/></th> --%>
				   <th style="width: 8%"><spring:message code="amazon_order_form24"/></th>
				   ...
				   <th style="width: 5%"><spring:message code="amazon_order_form27"/></th>
				   <th style="width: 8%"><spring:message code="sys_label_tips_operate"/></th>
			...
			<tr>
			   <c:if test="${'管理员' eq amazonUnlineOrder.orderChannel}">
			      ...
			      <select style="width: 90%" name="sellersku">
					<c:forEach items="${sku}" var="itemSku">
					   <c:if test="${fn:contains(asinMap[item.asin],itemSku.key)}">
				...
				<c:if test="${'管理员' ne amazonUnlineOrder.orderChannel}">
			      <td class="sku">
			      <select style="width: 90%" name="sellersku">
					<c:forEach items="${sku}" var="itemSku">
						<option value="${itemSku.key}" ${itemSku.key eq item.sellersku ?'selected':''}>${itemSku.value}</option>	
				...
				<input type="text" maxlength="10" style="width: 80%" name="quantityOrdered" class="digits required" value="${item.quantityOrdered}" onblur="setShipQuantity(this);" readonly="true">
				<input type="hidden" maxlength="11" style="width: 80%" name="quantityShipped" class="number required" value="${item.quantityOrdered}" readonly="true"/>
				</td>
				<%-- <td><input type="text" maxlength="11" style="width: 80%" name="quantityShipped" class="number required" value="${item.quantityShipped}" /></td> --%>
				<td><input type="text" maxlength="11" style="width: 80%" name="itemPrice" class="price required" value="${item.itemPrice}" onkeyup="getPrice1(this);" readonly="true"/></td>
				<td><input type="text" maxlength="11" style="width: 80%" name="itemTax" class="price" value="${item.itemTax}" onkeyup="getPrice2(this);" readonly="true"/></td>
				<td><input type="text" maxlength="11" style="width: 80%" name="includeTax" class="price"   onkeyup="getPrice3(this);" readonly="true"  value="<fmt:formatNumber value='${item.itemPrice+item.itemPrice*item.itemTax/100}' maxFractionDigits='2' /> " /></td>
				<td><input type="text" maxlength="11" style="width: 80%" name="shippingPrice" class="price" value="${item.shippingPrice}" readonly="true"/></td> 
				<td><input type="text" maxlength="11" style="width: 80%" name="giftWrapPrice" class="price" value="${item.giftWrapPrice}" readonly="true"/></td>
