	...
	<script type="text/javascript">
		...
		$(document).ready(function() {
			...
			$("#salesChannel").change(function(){
				...
				params['shippingAddress.addressLine1']=encodeURI($("input[name='shippingAddress.addressLine1']").val());
				params['shippingAddress.addressLine2']=encodeURI($("input[name='shippingAddress.addressLine2']").val());
				params['shippingAddress.addressLine3']=encodeURI($("input[name='shippingAddress.addressLine3']").val());
				params['shippingAddress.city']=encodeURI($("input[name='shippingAddress.city']").val());
				params['shippingAddress.county']=encodeURI($("input[name='shippingAddress.county']").val());
				params['shippingAddress.stateOrRegion']=encodeURI($("input[name='shippingAddress.stateOrRegion']").val());
				...
				params.buyerEmail=$("#buyerEmail").val();
				params.buyerName=encodeURI($("#buyerName").val());
				params.billNo=$("#billNo").val();
				params.supplier=$("#supplier").val();
				window.location.href = "${ctx}/amazoninfo/unlineOrder/add?"+$.param(params);
			...
			$("#searchByName").click(function(){
				...
				if(name==''){
					...
					$.post("${ctx}/amazoninfo/unlineOrder/getAddrInfo",{addrName:name},function(date){
						if(date!=null){
							 $("input[name='shippingAddress.addressLine1']").val(date.addressLine1);
								...
								$("input[name='shippingAddress.county']").val(date.county);
				...
				submitHandler: function(form){
					...
					if(!numberflag){
						...
						if(flag){
							...
							if(unShipped==0){
								aa="<spring:message code="amazon_order_tips22"/>";
							}else{
...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="#">Unline Order Add</a></li>
	</ul>
<br/>
	...
	<form:form id="inputForm" modelAttribute="amazonUnlineOrder"  action="${ctx}/amazoninfo/unlineOrder/saveAdd" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:select path="orderStatus" style="width: 200px" class="required" id="orderStatus">
	 ...
	 <table>
		...
		<tbody>
			<tr>
				...
				<td><input type="text" maxlength="11" style="width: 80%" name="itemPrice" class="price required" onkeyup="getPrice1(this);"/></td>
				<td><input type="text" maxlength="11" style="width: 80%" name="itemTax" class="price" onkeyup="getPrice2(this);"/></td>
				<td><input type="text" maxlength="11" style="width: 80%" name="includeTax" class="price" onkeyup="getPrice3(this);"/></td>
