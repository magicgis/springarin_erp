	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			$("#country").on("change",function(e){
				...
				window.location.href = "${ctx}/amazoninfo/discountWarning/add?"+$.param(params);
			});
...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="#">新建折扣预警</a></li>
	</ul><br/>
				...
				<div class="controls" style="margin-left:120px">
					<select name="country" id="country">
						<c:forEach items="${countrySet}" var="country">
							<option value="${country}" ${discountWarning.country eq country ?'selected':'' } >${fns:getDictLabel(country, 'platform', defaultValue)}</option>
						</c:forEach> 
					</select>
				</div>
			</div>
