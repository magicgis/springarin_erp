	...
	<script type="text/javascript">
		...
		$(document).ready(function() {
			$("#add-row").click(function(){
	              ...
	              cnt+="<div class='control-group'><label class='control-label'><b>CatalogType:</b></label><div class='controls'><input type='hidden' name='catalogType1' value='HomeImprovement'/><input type='hidden' name='catalogType2' value='Electrical'/> <select  style='width:25%' onchange='setCatalogTypeValue(this)' class='js-states form-control'>";
				   ...
				   cnt+=" <div class='control-group eanOrAsin' ><label class='control-label'><b>Sku:</b></label>";
				   cnt+=" <div class='controls'><input  type='text'  name='sku' class='required' style='width:200px;' value='${feed.sku }'/>";
					cnt+=" <input type='hidden' value='1' name='isFba'/>&nbsp;&nbsp;</div></div>";
	        	  
	        	
				   cnt+="<div class='control-group sku'><label class='control-label'><b>Ean:</b></label>";
				  cnt+="  <div class='controls'><input  type='text'  name='ean'  style='width:200px;' value='${feed.ean }'/></div></div>";
	        	  
				    cnt+=" <div class='control-group sku'><label class='control-label'><b>Asin:</b></label>";
					cnt+="  <div class='controls'><input  type='text'  name='asin'  style='width:200px;' value='${feed.asin }'/></div></div>";
		...
		function getCountrySku(c){
			...
			$.ajax({  
		        ...
		        dataType:"json",
		        data : "accountName="+ $('#accountName').val()+"&asin="+ean,  
		        async: true,
		...
		function queryAllInfo(c){
			$.ajax({  
		        ...
		        dataType:"json",
		        data : "accountName="+ $('#accountName').val()+"&asin="+$(c).find("option:selected").attr("asinVal"),  
		        async: true,
		        success : function(msg){
		 ...
		 <div class="main">
            <div>
                ...
                <ul class="nav nav-tabs" role="tablist" id="navTabs">
                      <li class="active asinTab" id="tab_0"><a href="#c_0" data-toggle="tab" aria-controls='0'><b>panel_0</b><i class="close-tab icon-remove"></i></a></li>  
                </ul>
                ...
                <div class="tab-content" id="tabContent">
                     ...
                     <div class="tab-pane active" id="c_0">
			        	 ...
			        	 <div class='control-group sku' ><label class='control-label'><b>Sku:</b></label>
				             <div class='controls'> 
				             <select name='sku' class='required' onchange='queryAllInfo(this)'>
				               <option value=''>-请选择sku-</option>
				                <c:forEach items='${list}' var='temp'>
							             <c:forEach items="${fn:split(temp.sku,',')}" var="single">
							                <option asinVal='${temp.asin }' value="${single}">${single}</option>
							             </c:forEach> 
							    </c:forEach> 
				             </select>
			        	 ...
			        	 <div class='controls'><input class='required price' type='text'  name='price'  style='width:100px;'/>&nbsp;&nbsp;</div></div>
			        	<!--  <div class='control-group' ><label class='control-label'><b>SalePrice:</b></label>
			        	 <div class='controls'><input class='required price' type='text'  name='salePrice'  style='width:100px;'/>&nbsp;&nbsp;</div></div>
			        	 -->
					      
					      <div class='control-group description' ><label class='control-label'><b>Description:</b></label>
						   <div class='controls'><textarea class='destroyArea required' id='description0' name='description'  style='float:left;margin: 0px; width:90%; height:407px;'>${feed.description }</textarea>
						   &nbsp;&nbsp;<div class='showMsg'></div>
						 </div></div>
						
						
					      <div class='control-group feature1' ><label class='control-label'><b>BulletPoint1:</b></label>
		        		  <div class='controls'><input class='required' type='text' value='${feed.feature1 }' onkeyup='getLen(this)'  name='feature1'   style='width:650.063px;height:19px;'/>&nbsp;&nbsp;<div class='showMsg'></div></div></div>
		        		  <div class='control-group feature2' ><label class='control-label'><b>BulletPoint2:</b></label>
		        		  <div class='controls'><input class='required' type='text' value='${feed.feature2 }' onkeyup='getLen(this)'  name='feature2' style='width:650.063px;height:19px;'/>&nbsp;&nbsp;<div class='showMsg'></div></div></div>
		        		  <div class='control-group feature3' ><label class='control-label'><b>BulletPoint3:</b></label>
		        		  <div class='controls'><input class='required' type='text' value='${feed.feature3 }' onkeyup='getLen(this)'  name='feature3'  style='width:650.063px;height:19px;'/>&nbsp;&nbsp;<div class='showMsg'></div></div></div>
		        		  <div class='control-group feature4' ><label class='control-label'><b>BulletPoint4:</b></label>
		        		  <div class='controls'><input class='required' type='text' value='${feed.feature4 }' onkeyup='getLen(this)'  name='feature4'   style='width:650.063px;height:19px;'/>&nbsp;&nbsp;<div class='showMsg'></div></div></div>
		        		  <div class='control-group feature5' ><label class='control-label'><b>BulletPoint5:</b></label>
		        		  <div class='controls'><input class='required' type='text' value='${feed.feature5 }' onkeyup='getLen(this)'  name='feature5' style='width:650.063px;height:19px;'/>&nbsp;&nbsp;<div class='showMsg'></div></div></div>
						   
				         
						
						 <div class='control-group keyword1' ><label class='control-label'><b>SearchTerms1:</b></label>
		        		  <div class='controls'><input class='required' type='text' value='${feed.keyword1 }' onkeyup='getLen(this)'  name='keyword1'  style='width:650.063px;height:19px;'/>&nbsp;&nbsp;<div class='showMsg'></div></div></div>
		        		  <div class='control-group keyword2' ><label class='control-label'><b>SearchTerms2:</b></label>
		        		  <div class='controls'><input class='required' type='text' value='${feed.keyword2 }' onkeyup='getLen(this)'  name='keyword2'  style='width:650.063px;height:19px;'/>&nbsp;&nbsp;<div class='showMsg'></div></div></div>
		        		  <div class='control-group keyword3' ><label class='control-label'><b>SearchTerms3:</b></label>
		        		  <div class='controls'><input class='required' type='text' value='${feed.keyword3 }' onkeyup='getLen(this)'  name='keyword3'  style='width:650.063px;height:19px;'/>&nbsp;&nbsp;<div class='showMsg'></div></div></div>
		        		  <div class='control-group keyword4' ><label class='control-label'><b>SearchTerms4:</b></label>
		        		  <div class='controls'><input class='required' type='text' value='${feed.keyword4 }' onkeyup='getLen(this)'  name='keyword4'  style='width:650.063px;height:19px;'/>&nbsp;&nbsp;<div class='showMsg'></div></div></div>
		        		  <div class='control-group keyword5' ><label class='control-label'><b>SearchTerms5:</b></label>
		        		  <div class='controls'><input class='required' type='text' value='${feed.keyword5 }' onkeyup='getLen(this)'  name='keyword5'  style='width:650.063px;height:19px;'/>&nbsp;&nbsp;<div class='showMsg'></div></div></div>
