			  ...
			  $("#event").change(function(){  
				  if($("#event").val()!=null&&$("#event").val()!=''){
					  $.ajax({  
					        ...
					        dataType:"json",
					        data : 'type=' +$("#orderType").val()+"&eventId="+$("#event").val(),  
					        async: false,
					        success : function(msg){ 
					        	...
					        	$("#showId").attr("href","${ctx}/custom/event/form?id="+$("#event").val());
					        	$("#showId").text($("#event").val());
					        	$("input[name='shippingAddress.street1']").val('');
				        		$("input[name='shippingAddress.street']").val('');
				        		$("input[name='shippingAddress.street2']").val('');
				        		$("input[name='shippingAddress.cityName']").val('');
								$("input[name='shippingAddress.county']").val('');
								$("input[name='shippingAddress.stateOrProvince']").val('');
					        	...
					        	if($("#orderType").val()=="2"||$("#orderType").val()=="5"){
					        		$("input[name='shippingAddress.street1']").val(msg.street1);
					        		$("input[name='shippingAddress.street']").val(msg.street);
					        		$("input[name='shippingAddress.street2']").val(msg.street2);
					        		$("input[name='shippingAddress.cityName']").val(msg.cityName);
									$("input[name='shippingAddress.county']").val(msg.street2);
									$("input[name='shippingAddress.stateOrProvince']").val(msg.stateOrProvince);
				...
				$("#channel").change(function(){
					...
					window.location.href = "${ctx}/amazonAndEbay/mfnOrder/add?"+$.param(params);
				});
...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="#">Order Add</a></li>
	</ul>
<br/>
	...
	<form:form id="inputForm" modelAttribute="mfnOrder"  action="${ctx}/amazonAndEbay/mfnOrder/saveAdd" method="post" class="form-horizontal">
		...
		<tr>
		 ...
		 <td>
				<div class="control-group">
					...
					<div class="controls">
						<form:select path="event.id" style="width: 400px" class="required" id="event">
						       <option value=""></option>
		...
		<blockquote>
		   ...
		   <tr><td>
				<div class="control-group">
					...
					<div class="controls">
						<form:select path="status" style="width: 220px" class="required" id="status">
		...
		<tbody>
			<tr>
				...
				<td><input type="text" maxlength="10" style="width: 80%" name="quantityPurchased" class="digits required" value="1">
				<!-- <input type="hidden" maxlength="10" style="width: 80%" name="quantityShipped" class="number required"> -->
				</td>
				<td><input type="text" maxlength="11" style="width: 80%" name="itemPrice" class="price" onblur="getPrice1(this);"/></td>
				<td><input type="text" maxlength="11" style="width: 80%" name="itemTax" class="price" onblur="getPrice2(this);"/></td>
				<td><input type="text" maxlength="11" style="width: 80%" name="includeTax" class="price" readonly='readonly'/></td>
				<td><input type="text" maxlength="11" style="width: 80%" name="codFee" class="price" /></td>
