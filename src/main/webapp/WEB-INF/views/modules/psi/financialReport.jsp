	...
	$.fn.dataTableExt.afnSortData['dom-html'] = function ( oSettings, iColumn ){
		...
		$(document).ready(function() {
			...
			$("#export").click(function(){
				...
				window.location.href = "${ctx}/psi/purchaseOrder/fReportExport?"+$.param(params);
...
<body>
    <ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/psi/purchaseOrder/fReport">采购支付报表</a></li>
		...
		<div class="alert alert-info" style="width:100%;text-align:center">1：由于本页显示的是美元对账，如果供应商币种为CNY，分摊到产品里面只保留2位精度，所以各金额比“对账”会稍微少点:2：本页“草稿”订单也统计进来了，所以“订单总金额”比“对账”里的会大</div>
	<form:form id="searchForm" modelAttribute="purchaseOrder" action="${ctx}/psi/purchaseOrder/fReport" method="post" class="breadcrumb form-search" cssStyle="height: 30px;">
	...
	<table id="dataTable" class="table table-bordered table-condensed">
		<thead><tr>
		<th width="5%">月份</th><th width="5%">订单总金额</th><th width="5%">实际支付定金</th><th width="5%">实际支付尾款</th><th width="5%">实际支付总额</th><th width="5%">未支付(截止到月末)</th></tr></thead>
		<tbody>
