	  ...
	  s.parentNode.insertBefore(hm, s);
		...
		$(document).ready(function() {
			...
			<c:forEach items="${purchaseOrder.supplier.products}" var="productSupplier" varStatus="i">
			  	product={};
			  	<c:if test='${productSupplier.product.isSale eq 1 }'>
		...
		$('#add-row').on('click', function(e){
			...
			$("#supplier").on("change",function(){
			 		...
			 		window.location.href = "${ctx}/psi/purchaseOrder/fastCreateOrder"+paramStr;
			 	});
...
<body>
	...
	<br/>
	<form:form id="inputForm" modelAttribute="purchaseOrder" action="${ctx}/psi/purchaseOrder/fastSave" method="post" class="form-horizontal">
