...
<head>
	...
	$(document).ready(function() {
		...
		/* 	if(!userId){
			...
			$.get("${ctx}/psi/psiProductManageGroup/seveGroupCustomer?"+$.param(param),function(data){
				if(!(data)){    
...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/psi/psiProductManageGroup/findGroupCustomer"><spring:message code="psi_product_event"/></a></li>
