	...
	<script type="text/javascript">
		...
		$(document).ready(function() {
			$("#btnSubmit").click(function(){
				$("#searchForm").attr("action","${ctx}/psi/psiTransportPayment/exportTransportReport");
				$("#searchForm").submit();
				$("#searchForm").attr("action","${ctx}/psi/psiTransportPayment/byMonthInfo");
			});
			...
			$("#btnSubmit2").click(function(){
				top.$.jBox.confirm("<input style='width: 160px'  readonly='readonly'  class='Wdate' type='text' onclick=WdatePicker({dateFmt:'yyyy'}); />", "Select Export Year", function(v, h, f){
					  if (v == 'ok'){
						  	...
						  	if(params.year){
						  		$("#searchForm").attr("action","${ctx}/psi/lcPsiTransportOrder/expTransportCost?"+$.param(params));
								$("#searchForm").submit();
								$("#searchForm").attr("action","${ctx}/psi/psiTransportPayment/byMonthInfo");
						  	}else{
						  		return false;
...
<body>
    <ul class="nav nav-tabs">
	  <li class="active"><a href="${ctx}/psi/psiTransportPayment/byMonthInfo">物流报表</a></li>
	...
	<form id="searchForm" action="${ctx}/psi/psiTransportPayment/byMonthInfo" method="post" class="breadcrumb form-search" cssStyle="height: 80px;">
	   &nbsp;&nbsp;&nbsp;&nbsp;统计时间:
	    ...
	    <input id="btnSubmit2" class="btn btn-primary" type="button" value="物流成本导出"/>
	</form>
