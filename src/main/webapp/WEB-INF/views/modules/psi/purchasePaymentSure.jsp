...
<body>
	...
	<form:form id="inputForm" modelAttribute="purchasePayment" action="${ctx}/psi/purchasePayment/sureSave" method="post" class="form-horizontal" enctype="multipart/form-data" >
