	...
	<script type="text/javascript">
		...
		$(document).ready(function() {
			$("#btnSubmit").click(function(){
				$("#searchForm").attr("action","${ctx}/psi/psiTransportPayment/exportTransportReport2");
				$("#searchForm").submit();
				$("#searchForm").attr("action","${ctx}/psi/psiTransportPayment/byMonthTransport");
			});
			
			$("#byMonth").click(function(){
				$("#searchForm").attr("action","${ctx}/psi/psiTransportPayment/exportAllTransportInfo");
				$("#searchForm").submit();
				$("#searchForm").attr("action","${ctx}/psi/psiTransportPayment/byMonthTransport");
			});
			
			$("#byTotal").click(function(){
				$("#searchForm").attr("action","${ctx}/psi/psiTransportPayment/exportTotalTransportInfo");
				$("#searchForm").submit();
				$("#searchForm").attr("action","${ctx}/psi/psiTransportPayment/byMonthTransport");
			});
...
<body>
   <ul class="nav nav-tabs">
	  ...
	  <li class="active"><a href="${ctx}/psi/psiTransportPayment/byMonthTransport">运输分析</a></li>
	...
	<form id="searchForm" action="${ctx}/psi/psiTransportPayment/byMonthTransport" method="post"  class="breadcrumb form-search" cssStyle="height: 80px;">
	   &nbsp;&nbsp;&nbsp;&nbsp;统计时间:
	...
	<table id="Money" class="table table-striped table-bordered table-condensed">
		...
		<tbody>
		     ...
		     <tr style="background-color:#cccccc">
		      ...
		      <tr style="background-color:#cccccc"> 
		         <td style="text-align: center;vertical-align: middle;background-color:#cccccc;">AE_Total/RMB</td>
		         <td style="text-align: center;vertical-align: middle;background-color:#cccccc;"></td>
		         <c:set var="total" value="0" />
		         <c:forEach items="${byMonthTransportMoney}" var="moneyTitle">
		           <c:set var="total" value="${total+byMonthTransportMoney[moneyTitle.key]['eu']['0']+byMonthTransportMoney[moneyTitle.key]['US']['0']+byMonthTransportMoney[moneyTitle.key]['jp']['0']}" />
		           <td style="text-align: center;vertical-align: middle;background-color:#cccccc;"><fmt:formatNumber  value="${byMonthTransportMoney[moneyTitle.key]['eu']['0']+byMonthTransportMoney[moneyTitle.key]['US']['0']+byMonthTransportMoney[moneyTitle.key]['jp']['0'] }"  maxFractionDigits="1"/></td>
		         </c:forEach>
		      ...
		      <tr style="background-color:#cccccc"> 
		         <td style="text-align: center;vertical-align: middle;background-color:#cccccc;">OE_Total/RMB</td>
		         <td style="text-align: center;vertical-align: middle;background-color:#cccccc;"></td>
		         <c:set var="total" value="0" />
		         <c:forEach items="${byMonthTransportMoney}" var="moneyTitle">
		           <c:set var="total" value="${total+byMonthTransportMoney[moneyTitle.key]['eu']['1']+byMonthTransportMoney[moneyTitle.key]['US']['1']+byMonthTransportMoney[moneyTitle.key]['jp']['1']}" />
		           <td style="text-align: center;vertical-align: middle;background-color:#cccccc;"><fmt:formatNumber  value="${byMonthTransportMoney[moneyTitle.key]['eu']['1']+byMonthTransportMoney[moneyTitle.key]['US']['1']+byMonthTransportMoney[moneyTitle.key]['jp']['1'] }"  maxFractionDigits="1"/></td>
		         </c:forEach>
		         <td style="text-align: center;vertical-align: middle;background-color:#cccccc;"><fmt:formatNumber value="${total }"  maxFractionDigits="1"/></td>
		      </tr>
		      <tr style="background-color:#cccccc"> 
		         <td style="text-align: center;vertical-align: middle;background-color:#cccccc;">EX_Total/RMB</td>
		         <td style="text-align: center;vertical-align: middle;background-color:#cccccc;"></td>
		        <c:set var="total" value="0" />
		         <c:forEach items="${byMonthTransportMoney}" var="moneyTitle">
		           <c:set var="total" value="${total+byMonthTransportMoney[moneyTitle.key]['eu']['2']+byMonthTransportMoney[moneyTitle.key]['US']['2']+byMonthTransportMoney[moneyTitle.key]['jp']['2']}" />
		           <td style="text-align: center;vertical-align: middle;background-color:#cccccc;"><fmt:formatNumber  value="${byMonthTransportMoney[moneyTitle.key]['eu']['2']+byMonthTransportMoney[moneyTitle.key]['US']['2']+byMonthTransportMoney[moneyTitle.key]['jp']['2'] }"  maxFractionDigits="1"/></td>
		         </c:forEach>
		         <td style="text-align: center;vertical-align: middle;background-color:#cccccc;"><fmt:formatNumber value="${total }"  maxFractionDigits="1"/></td>
		       </tr>
		     <tr style="background-color:#cccccc"> 
	...
	<table id="UnitPrice" class="table table-striped table-bordered table-condensed">
		...
		<tbody>
		     <tr>
		       ...
		       <c:forEach items="${byMonthTransportMoney}" var="moneyTitle">
		           <c:set var="euTotal" value="${euTotal+byMonthTransportMoney[moneyTitle.key]['eu']['0'] }" />
		           <c:set var="euTotal1" value="${euTotal1+byMonthTransport[moneyTitle.key]['eu']['0'] }" />
		           <td style="text-align: center;vertical-align: middle;">
			           <c:if test="${byMonthTransport[moneyTitle.key]['eu']['0']>0 }"> 
			              <fmt:formatNumber  value="${byMonthTransportMoney[moneyTitle.key]['eu']['0']/byMonthTransport[moneyTitle.key]['eu']['0'] }"  maxFractionDigits="1"/>
			           </c:if> 
		           </td>
		       </c:forEach>
		       <td style="text-align: center;vertical-align: middle;background-color:#cccccc;">
		     ...
		     <tr>
		       ...
		       <c:forEach items="${byMonthTransportMoney}" var="moneyTitle">
		           <c:set var="euTotal" value="${euTotal+byMonthTransportMoney[moneyTitle.key]['eu']['1'] }" />
		            <c:set var="euTotal1" value="${euTotal1+byMonthTransport[moneyTitle.key]['eu']['1'] }" />
		           <td style="text-align: center;vertical-align: middle;">
		            <c:if test="${byMonthTransport[moneyTitle.key]['eu']['1']>0 }"> 
		              <fmt:formatNumber  value="${byMonthTransportMoney[moneyTitle.key]['eu']['1']/byMonthTransport[moneyTitle.key]['eu']['1'] }"  maxFractionDigits="1"/>
		             </c:if>  
		           </td>
		       </c:forEach>
		     ...
		     <tr>
		       ...
		       <c:forEach items="${byMonthTransportMoney}" var="moneyTitle">
		           <c:set var="euTotal" value="${euTotal+byMonthTransportMoney[moneyTitle.key]['eu']['2'] }" />
		           <c:set var="euTotal1" value="${euTotal1+byMonthTransport[moneyTitle.key]['eu']['2'] }" />
		           <td style="text-align: center;vertical-align: middle;">
		               <c:if test="${byMonthTransport[moneyTitle.key]['eu']['2']>0 }"> 
		                  <fmt:formatNumber  value="${byMonthTransportMoney[moneyTitle.key]['eu']['2']/byMonthTransport[moneyTitle.key]['eu']['2'] }"  maxFractionDigits="1"/>
		               </c:if>   
		           </td>
		       </c:forEach>
		       <td style="text-align: center;vertical-align: middle;background-color:#cccccc;"><c:if test="${euTotal1>0 }"><fmt:formatNumber value="${euTotal*1.0/euTotal1 }"  maxFractionDigits="1"/></c:if> </td>
		     ...
		     <tr>
		       ...
		       <c:forEach items="${byMonthTransportMoney}" var="moneyTitle">
		           <c:set var="euTotal" value="${euTotal+byMonthTransportMoney[moneyTitle.key]['eu']['3'] }" />
		           <c:set var="euTotal1" value="${euTotal1+byMonthTransport[moneyTitle.key]['eu']['3'] }" />
		           <td style="text-align: center;vertical-align: middle;">
		               <c:if test="${byMonthTransport[moneyTitle.key]['eu']['3']>0 }"> 
		                  <fmt:formatNumber  value="${byMonthTransportMoney[moneyTitle.key]['eu']['3']/byMonthTransport[moneyTitle.key]['eu']['3'] }"  maxFractionDigits="1"/>
		               </c:if>   
		           </td>
		       </c:forEach>
		       <td style="text-align: center;vertical-align: middle;background-color:#cccccc;"><c:if test="${euTotal1>0 }"><fmt:formatNumber value="${euTotal*1.0/euTotal1 }"  maxFractionDigits="1"/></c:if> </td>
		     ...
		     <tr style="background-color:#cccccc">
		       ...
		       <c:forEach items="${byMonthTransportMoney}" var="moneyTitle">
		           <c:set var="euTotal" value="${euTotal+byMonthTransportMoney[moneyTitle.key]['eu']['0']+byMonthTransportMoney[moneyTitle.key]['eu']['1']+byMonthTransportMoney[moneyTitle.key]['eu']['2']+byMonthTransportMoney[moneyTitle.key]['eu']['3'] }" />
		           <c:set var="euTotal1" value="${euTotal1+byMonthTransport[moneyTitle.key]['eu']['0']+byMonthTransport[moneyTitle.key]['eu']['1']+byMonthTransport[moneyTitle.key]['eu']['2']+byMonthTransport[moneyTitle.key]['eu']['3'] }" />
		           <td style="text-align: center;vertical-align: middle;background-color:#cccccc;">
		            <c:if test="${byMonthTransport[moneyTitle.key]['eu']['0']+byMonthTransport[moneyTitle.key]['eu']['1']+byMonthTransport[moneyTitle.key]['eu']['2']+byMonthTransport[moneyTitle.key]['eu']['3']>0 }"> 
		             <fmt:formatNumber value="${(byMonthTransportMoney[moneyTitle.key]['eu']['0']+byMonthTransportMoney[moneyTitle.key]['eu']['1']+byMonthTransportMoney[moneyTitle.key]['eu']['2']+byMonthTransportMoney[moneyTitle.key]['eu']['3'])/(byMonthTransport[moneyTitle.key]['eu']['0']+byMonthTransport[moneyTitle.key]['eu']['1']+byMonthTransport[moneyTitle.key]['eu']['2']+byMonthTransport[moneyTitle.key]['eu']['3']) }"  maxFractionDigits="1"/>
		            </c:if>   
		            </td>
		       </c:forEach>
		       <td style="text-align: center;vertical-align: middle;background-color:#cccccc;"><c:if test="${euTotal1>0 }"><fmt:formatNumber  value="${euTotal*1.0/euTotal1 }"  maxFractionDigits="1"/></c:if></td>
		     ...
		     <tr>
		       ...
		       <c:forEach items="${byMonthTransportMoney}" var="moneyTitle">
		           <c:set var="euTotal" value="${euTotal+byMonthTransportMoney[moneyTitle.key]['US']['0'] }" />
		           <c:set var="euTotal1" value="${euTotal1+byMonthTransport[moneyTitle.key]['US']['0'] }" />
		           <td style="text-align: center;vertical-align: middle;">
			           <c:if test="${byMonthTransport[moneyTitle.key]['US']['0']>0 }"> 
			              <fmt:formatNumber  value="${byMonthTransportMoney[moneyTitle.key]['US']['0']/byMonthTransport[moneyTitle.key]['US']['0'] }"  maxFractionDigits="1"/>
			           </c:if> 
		           </td>
		       </c:forEach>
		       <td style="text-align: center;vertical-align: middle;background-color:#cccccc;">
		     ...
		     <tr>
		       ...
		       <c:forEach items="${byMonthTransportMoney}" var="moneyTitle">
		           <c:set var="euTotal" value="${euTotal+byMonthTransportMoney[moneyTitle.key]['US']['1'] }" />
		            <c:set var="euTotal1" value="${euTotal1+byMonthTransport[moneyTitle.key]['US']['1'] }" />
		           <td style="text-align: center;vertical-align: middle;">
		            <c:if test="${byMonthTransport[moneyTitle.key]['US']['1']>0 }"> 
		              <fmt:formatNumber  value="${byMonthTransportMoney[moneyTitle.key]['US']['1']/byMonthTransport[moneyTitle.key]['US']['1'] }"  maxFractionDigits="1"/>
		             </c:if>  
		           </td>
		       </c:forEach>
		       <td style="text-align: center;vertical-align: middle;background-color:#cccccc;"><c:if test="${euTotal1>0 }"><fmt:formatNumber value="${euTotal*1.0/euTotal1 }"  maxFractionDigits="1"/> </c:if>  </td>
		     ...
		     <tr>
		       ...
		       <c:forEach items="${byMonthTransportMoney}" var="moneyTitle">
		           <c:set var="euTotal" value="${euTotal+byMonthTransportMoney[moneyTitle.key]['US']['2'] }" />
		           <c:set var="euTotal1" value="${euTotal1+byMonthTransport[moneyTitle.key]['US']['2'] }" />
		           <td style="text-align: center;vertical-align: middle;">
		               <c:if test="${byMonthTransport[moneyTitle.key]['US']['2']>0 }"> 
		                  <fmt:formatNumber  value="${byMonthTransportMoney[moneyTitle.key]['US']['2']/byMonthTransport[moneyTitle.key]['US']['2'] }"  maxFractionDigits="1"/>
		               </c:if>   
		           </td>
		       </c:forEach>
		       <td style="text-align: center;vertical-align: middle;background-color:#cccccc;"><c:if test="${euTotal1>0 }"><fmt:formatNumber value="${euTotal*1.0/euTotal1 }"  maxFractionDigits="1"/></c:if> </td>
		     ...
		     <tr style="background-color:#cccccc">
		       ...
		       <c:forEach items="${byMonthTransportMoney}" var="moneyTitle">
		           <c:set var="euTotal" value="${euTotal+byMonthTransportMoney[moneyTitle.key]['US']['0']+byMonthTransportMoney[moneyTitle.key]['US']['1']+byMonthTransportMoney[moneyTitle.key]['US']['2'] }" />
		           <c:set var="euTotal1" value="${euTotal1+byMonthTransport[moneyTitle.key]['US']['0']+byMonthTransport[moneyTitle.key]['US']['1']+byMonthTransport[moneyTitle.key]['US']['2'] }" />
		           <td style="text-align: center;vertical-align: middle;">
		            <c:if test="${byMonthTransport[moneyTitle.key]['US']['0']+byMonthTransport[moneyTitle.key]['US']['1']+byMonthTransport[moneyTitle.key]['US']['2']>0 }"> 
		             <fmt:formatNumber value="${(byMonthTransportMoney[moneyTitle.key]['US']['0']+byMonthTransportMoney[moneyTitle.key]['US']['1']+byMonthTransportMoney[moneyTitle.key]['US']['2'])/(byMonthTransport[moneyTitle.key]['US']['0']+byMonthTransport[moneyTitle.key]['US']['1']+byMonthTransport[moneyTitle.key]['US']['2']) }"  maxFractionDigits="1"/>
		            </c:if>   
		            </td>
		       </c:forEach>
		       <td style="text-align: center;vertical-align: middle;background-color:#cccccc;"><c:if test="${euTotal1>0 }"><fmt:formatNumber  value="${euTotal*1.0/euTotal1 }"  maxFractionDigits="1"/></c:if></td>
		       ...
		       <c:forEach items="${byMonthTransportMoney}" var="moneyTitle">
		           <c:set var="euTotal" value="${euTotal+byMonthTransportMoney[moneyTitle.key]['jp']['0'] }" />
		           <c:set var="euTotal1" value="${euTotal1+byMonthTransport[moneyTitle.key]['jp']['0'] }" />
		           <td style="text-align: center;vertical-align: middle;">
			           <c:if test="${byMonthTransport[moneyTitle.key]['jp']['0']>0 }"> 
			              <fmt:formatNumber  value="${byMonthTransportMoney[moneyTitle.key]['jp']['0']/byMonthTransport[moneyTitle.key]['jp']['0'] }"  maxFractionDigits="1"/>
			           </c:if> 
		           </td>
		       </c:forEach>
		       <td style="text-align: center;vertical-align: middle;background-color:#cccccc;">
		     ...
		     <tr>
		       ...
		       <c:forEach items="${byMonthTransportMoney}" var="moneyTitle">
		           <c:set var="euTotal" value="${euTotal+byMonthTransportMoney[moneyTitle.key]['jp']['1'] }" />
		            <c:set var="euTotal1" value="${euTotal1+byMonthTransport[moneyTitle.key]['jp']['1'] }" />
		           <td style="text-align: center;vertical-align: middle;">
		            <c:if test="${byMonthTransport[moneyTitle.key]['jp']['1']>0 }"> 
		              <fmt:formatNumber  value="${byMonthTransportMoney[moneyTitle.key]['jp']['1']/byMonthTransport[moneyTitle.key]['jp']['1'] }"  maxFractionDigits="1"/>
		             </c:if>  
		           </td>
		       </c:forEach>
		       <td style="text-align: center;vertical-align: middle;background-color:#cccccc;"><c:if test="${euTotal1>0 }"><fmt:formatNumber value="${euTotal*1.0/euTotal1 }"  maxFractionDigits="1"/> </c:if>  </td>
		     ...
		     <tr>
		       ...
		       <c:forEach items="${byMonthTransportMoney}" var="moneyTitle">
		           <c:set var="euTotal" value="${euTotal+byMonthTransportMoney[moneyTitle.key]['jp']['2'] }" />
		           <c:set var="euTotal1" value="${euTotal1+byMonthTransport[moneyTitle.key]['jp']['2'] }" />
		           <td style="text-align: center;vertical-align: middle;">
		               <c:if test="${byMonthTransport[moneyTitle.key]['jp']['2']>0 }"> 
		                  <fmt:formatNumber  value="${byMonthTransportMoney[moneyTitle.key]['jp']['2']/byMonthTransport[moneyTitle.key]['jp']['2'] }"  maxFractionDigits="1"/>
		               </c:if>   
		           </td>
		       </c:forEach>
		       <td style="text-align: center;vertical-align: middle;background-color:#cccccc;"><c:if test="${euTotal1>0 }"><fmt:formatNumber value="${euTotal*1.0/euTotal1 }"  maxFractionDigits="1"/></c:if> </td>
		     ...
		     <tr style="background-color:#cccccc">
		       ...
		       <c:forEach items="${byMonthTransportMoney}" var="moneyTitle">
		           <c:set var="euTotal" value="${euTotal+byMonthTransportMoney[moneyTitle.key]['jp']['0']+byMonthTransportMoney[moneyTitle.key]['jp']['1']+byMonthTransportMoney[moneyTitle.key]['jp']['2'] }" />
		           <c:set var="euTotal1" value="${euTotal1+byMonthTransport[moneyTitle.key]['jp']['0']+byMonthTransport[moneyTitle.key]['jp']['1']+byMonthTransport[moneyTitle.key]['jp']['2'] }" />
		           <td style="text-align: center;vertical-align: middle;">
		            <c:if test="${byMonthTransport[moneyTitle.key]['jp']['0']+byMonthTransport[moneyTitle.key]['jp']['1']+byMonthTransport[moneyTitle.key]['jp']['2']>0 }"> 
		             <fmt:formatNumber value="${(byMonthTransportMoney[moneyTitle.key]['jp']['0']+byMonthTransportMoney[moneyTitle.key]['jp']['1']+byMonthTransportMoney[moneyTitle.key]['jp']['2'])/(byMonthTransport[moneyTitle.key]['jp']['0']+byMonthTransport[moneyTitle.key]['jp']['1']+byMonthTransport[moneyTitle.key]['jp']['2']) }"  maxFractionDigits="1"/>
		            </c:if>   
		            </td>
		       </c:forEach>
		       <td style="text-align: center;vertical-align: middle;background-color:#cccccc;"><c:if test="${euTotal1>0 }"><fmt:formatNumber  value="${euTotal*1.0/euTotal1 }"  maxFractionDigits="1"/></c:if></td>
		         ...
		         <c:forEach items="${byMonthTransportMoney}" var="moneyTitle">
		           ...
		           <td style="text-align: center;vertical-align: middle;background-color:#cccccc;">
		            <c:if test="${byMonthTransport[moneyTitle.key]['eu']['0']+byMonthTransport[moneyTitle.key]['eu']['1']+byMonthTransport[moneyTitle.key]['eu']['2']+byMonthTransport[moneyTitle.key]['eu']['3']+byMonthTransport[moneyTitle.key]['US']['0']+byMonthTransport[moneyTitle.key]['US']['1']+byMonthTransport[moneyTitle.key]['US']['2']+byMonthTransport[moneyTitle.key]['jp']['0']+byMonthTransport[moneyTitle.key]['jp']['1']+byMonthTransport[moneyTitle.key]['jp']['2']>0 }">
		              <fmt:formatNumber  value="${(byMonthTransportMoney[moneyTitle.key]['eu']['0']+byMonthTransportMoney[moneyTitle.key]['eu']['1']+byMonthTransportMoney[moneyTitle.key]['eu']['2']+byMonthTransportMoney[moneyTitle.key]['eu']['3']+byMonthTransportMoney[moneyTitle.key]['US']['0']+byMonthTransportMoney[moneyTitle.key]['US']['1']+byMonthTransportMoney[moneyTitle.key]['US']['2']+byMonthTransportMoney[moneyTitle.key]['jp']['0']+byMonthTransportMoney[moneyTitle.key]['jp']['1']+byMonthTransportMoney[moneyTitle.key]['jp']['2'])/(byMonthTransport[moneyTitle.key]['eu']['0']+byMonthTransport[moneyTitle.key]['eu']['1']+byMonthTransport[moneyTitle.key]['eu']['2']+byMonthTransport[moneyTitle.key]['eu']['3']+byMonthTransport[moneyTitle.key]['US']['0']+byMonthTransport[moneyTitle.key]['US']['1']+byMonthTransport[moneyTitle.key]['US']['2']+byMonthTransport[moneyTitle.key]['jp']['0']+byMonthTransport[moneyTitle.key]['jp']['1']+byMonthTransport[moneyTitle.key]['jp']['2']) }"  maxFractionDigits="1"/>
		            </c:if>
		           </td>
		         </c:forEach>
