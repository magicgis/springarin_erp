	  ...
	  s.parentNode.insertBefore(hm, s);
		...
		$(document).ready(function() {
			$("#receipt").click(function(e){
				...
				$("#searchForm").attr("action","${ctx}/psi/lcPsiLadingBill/receiptCargoList?supplier.id="+supplierId+"");
				$("#searchForm").submit();
			});
			...
			$("#supplier").change(function(){
				$("#searchForm").attr("action","${ctx}/psi/lcPurchaseOrder/lessCargoList?supplier.id="+$(this).val()+"");
				$("#searchForm").submit();
			});
