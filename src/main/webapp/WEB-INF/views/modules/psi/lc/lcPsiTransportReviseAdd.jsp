	  ...
	  s.parentNode.insertBefore(hm, s);
		...
		$(document).ready(function() {
			...
			$("#supplier").on("change",function(){
				...
				window.location.href = "${ctx}/psi/lcPsiTransportOrder/revise?"+$.param(params);
			});
...
<body>
	...
	<form:form id="inputForm" modelAttribute="psiTransportRevise" action="${ctx}/psi/lcPsiTransportRevise/save" method="post" class="form-horizontal" enctype="multipart/form-data">
