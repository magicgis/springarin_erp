...
<body>
	...
	<form:form id="inputForm" modelAttribute="psiTransportPayment" action="${ctx}/psi/lcPsiTransportPayment/sureSave" method="post" class="form-horizontal" enctype="multipart/form-data">
