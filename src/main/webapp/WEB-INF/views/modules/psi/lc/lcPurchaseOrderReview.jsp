		...
		$(document).ready(function() {
			...
			$("#inputForm").validate({
				submitHandler: function(form){
					...
					if(flagInt==2){
						top.$.jBox.confirm('装箱数不为整数被,确定要审核通过吗', '提示', function (v, h, f) {
				            if (v == 'ok') {
...
<body>
	...
	<br/>
	<form:form id="inputForm" modelAttribute="purchaseOrder" action="${ctx}/psi/lcPurchaseOrder/reviewSave" method="post" class="form-horizontal" >
