...
<body>
	...
	<form:form id="searchForm" modelAttribute="lcPsiPartsInventoryTaking" action="${ctx}/psi/lcPsiPartsInventoryTaking/" method="post" class="breadcrumb form-search">
		...
		<select name="takingType" id="takingType">
			...
			<option value="0" ${lcPsiPartsInventoryTaking.takingType eq '0'?'selected':''} >盘入</option>
			<option value="1" ${lcPsiPartsInventoryTaking.takingType eq '1'?'selected':''} >盘出</option>
		</select>
		&nbsp;&nbsp;&nbsp;&nbsp;
