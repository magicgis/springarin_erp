	  ...
	  s.parentNode.insertBefore(hm, s);
		...
		$(document).ready(function() {
			...
			$("#supplier").on("change",function(e){
				...
				window.location.href = "${ctx}/psi/lcPsiPartsPayment/add?"+$.param(params);
			});
...
<body>
	...
	<form:form id="inputForm" modelAttribute="psiPartsPayment" action="${ctx}/psi/lcPsiPartsPayment/addSave" method="post" class="form-horizontal">
