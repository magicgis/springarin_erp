...
<head>
					 ...
					 if($(this).text()=="支付运费"){
							top.$.jBox.confirm('是否支付运费?','支付确认',function(v,h,f){
								if(v=='ok'){
									...
									$.get("${ctx}/psi/lcPsiTransportOrder/confirmPay?"+$.param(params),function(data){
										if(data){
	...
	<body>
		<ul class="nav nav-tabs">
			...
			<li class="active"><a href="#">(理诚)<c:if test="${psiTransportOrder.model eq '0'}"><spring:message code="psi_transport_air"/></c:if><c:if test="${psiTransportOrder.model eq '1'}"><spring:message code="psi_transport_sea"/></c:if><c:if test="${psiTransportOrder.model eq '2'}"><spring:message code="psi_transport_expr"/></c:if></a></li>
		</ul><br/>
		<form:form id="inputForm" modelAttribute="psiTransportOrder" action="${ctx}/psi/lcPsiTransportOrder/save" method="post" class="form-horizontal">
		<blockquote>
		...
		<div style="float:left;width:98%">
			<div class="control-group" style="float:left;width:15%;height:25px">
				...
				<div class="controls" style="margin-left:100px" >
					<input type="text" maxlength="10" style="width:85%"  class="price" value="${psiTransportOrder.declareAmount}" readonly="readonly"/>
				</div>
			</div>
			<div class="control-group" style="float:left;width:20%;height:25px">
				<label class="control-label" style="width:80px">退税金额:</label>
				<div class="controls" style="margin-left:100px" >
					<input type="text" maxlength="10" style="width:85%"  class="price" value="${psiTransportOrder.taxRefundAmount}" readonly="readonly"/>
				</div>
			</div>
			...
			<div class="control-group" style="float:left;width:98%;height:40px">
					...
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<c:forEach items="${fn:split(psiTransportOrder.tranPath,',')}" var="attchment" varStatus="i">
							<a target="_blank" href="<c:url value='/data/site/psi/lcPsiTransport/${attchment}'/>"><spring:message code="psi_transport_transportFee"/>_${i.index+1}</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						</c:forEach> 
					</c:if>
					...
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<c:forEach items="${fn:split(psiTransportOrder.dapPath,',')}" var="attchment" varStatus="i">
							<a target="_blank" href="<c:url value='/data/site/psi/lcPsiTransport/${attchment}'/>"><spring:message code="psi_transport_destFee"/>_${i.index+1}</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						</c:forEach> 
					</c:if>
					...
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<c:forEach items="${fn:split(psiTransportOrder.otherPath,',')}" var="attchment" varStatus="i">
							<a target="_blank" href="<c:url value='/data/site/psi/lcPsiTransport/${attchment}'/>"><spring:message code="psi_transport_otherFee"/>_${i.index+1}</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						</c:forEach> 
					</c:if>
					...
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<c:forEach items="${fn:split(psiTransportOrder.otherPath1,',')}" var="attchment" varStatus="i">
							<a target="_blank" href="<c:url value='/data/site/psi/lcPsiTransport/${attchment}'/>"><spring:message code="psi_transport_otherFee"/>1_${i.index+1}</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						</c:forEach> 
					</c:if>
					...
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<c:forEach items="${fn:split(psiTransportOrder.insurancePath,',')}" var="attchment" varStatus="i">
							<a target="_blank" href="<c:url value='/data/site/psi/lcPsiTransport/${attchment}'/>"><spring:message code="psi_transport_insuranceFee"/>_${i.index+1}</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						</c:forEach> 
					</c:if>
					...
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<c:forEach items="${fn:split(psiTransportOrder.taxPath,',')}" var="attchment" varStatus="i">
							<a target="_blank" href="<c:url value='/data/site/psi/lcPsiTransport/${attchment}'/>">Tax_${i.index+1}</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						</c:forEach>
					</c:if>
		...
		<div style="float:left;width:98%;height:50px;">
			...
			<c:forEach items="${fn:split(psiTransportOrder.suffixName,'-')}" var="attFile" varStatus="i">
					<c:choose>
						<c:when test="${fn:contains('.png,.pdf,.jpg,.JPG',attFile)}">
							<c:choose>    
								<c:when test="${i.index eq 0 && attFile ne 'PI' && attFile ne ''}"><a target="_blank" href="<c:url value='/data/site/psi/psiTransport/${psiTransportOrder.transportNo}/${psiTransportOrder.transportNo}_PI${attFile}'/>">PI_HK Download</a>
								...
								&nbsp;&nbsp;&nbsp;&nbsp;</c:when>
								<c:when test="${i.index eq 1 && attFile ne 'PL' }"><a target="_blank" href="<c:url value='/data/site/psi/psiTransport/${psiTransportOrder.transportNo}/${psiTransportOrder.transportNo}_PL${attFile}'/>">PL-HK Download</a>&nbsp;&nbsp;&nbsp;&nbsp;</c:when>
								<c:when test="${i.index eq 2 && attFile ne 'WB' }"><a target="_blank" href="<c:url value='/data/site/psi/psiTransport/${psiTransportOrder.transportNo}/${psiTransportOrder.transportNo}_WB${attFile}'/>">BL-HK Download</a>&nbsp;&nbsp;&nbsp;&nbsp;</c:when>
								...
								<c:when test="${i.index eq 8 && attFile ne 'CS' }"><a target="_blank" href="<c:url value='/data/site/psi/psiTransport/${psiTransportOrder.transportNo}/${psiTransportOrder.transportNo}_CS${attFile}'/>"><spring:message code="psi_transport_contract"/>-LC Download</a>&nbsp;&nbsp;&nbsp;&nbsp;</c:when>
						...
						<c:otherwise>
							<c:choose>
								<c:when test="${i.index eq 0 && attFile ne 'PI' && attFile ne '' }"><a href="${ctx}/psi/lcPsiTransportOrder/download?fileName=/${psiTransportOrder.transportNo}/${psiTransportOrder.transportNo}_PI${attFile}">PI_HK Download</a>
									<shiro:hasPermission name="psi:transport:confirmPay">
										<c:choose>
											<c:when test="${psiTransportOrder.confirmPay eq '1' }">
												<span class="label">已支付运费</span>
								...
								&nbsp;&nbsp;&nbsp;&nbsp;</c:when>
								<c:when test="${i.index eq 1 && attFile ne 'PL' }"><a href="${ctx}/psi/lcPsiTransportOrder/download?fileName=/${psiTransportOrder.transportNo}/${psiTransportOrder.transportNo}_PL${attFile}">PL-HK Download</a>&nbsp;&nbsp;&nbsp;&nbsp;</c:when>
								<c:when test="${i.index eq 2 && attFile ne 'WB' }"><a href="${ctx}/psi/lcPsiTransportOrder/download?fileName=/${psiTransportOrder.transportNo}/${psiTransportOrder.transportNo}_WB${attFile}">BL-HK Download</a>&nbsp;&nbsp;&nbsp;&nbsp;</c:when>
								<c:when test="${i.index eq 3 && attFile ne 'TI' }"><a href="${ctx}/psi/lcPsiTransportOrder/download?fileName=/${psiTransportOrder.transportNo}/${psiTransportOrder.transportNo}_TI${attFile}"><spring:message code="psi_transport_commercial"/> Download</a>&nbsp;&nbsp;&nbsp;&nbsp;</c:when>
								<c:when test="${i.index eq 4 && attFile ne 'SO' }"><a href="${ctx}/psi/lcPsiTransportOrder/download?fileName=/${psiTransportOrder.transportNo}/${psiTransportOrder.transportNo}_SO${attFile}">SO Download</a>&nbsp;&nbsp;&nbsp;&nbsp;</c:when>
								<c:when test="${i.index eq 5 && attFile ne 'WV' }"><a href="${ctx}/psi/lcPsiTransportOrder/download?fileName=/${psiTransportOrder.transportNo}/${psiTransportOrder.transportNo}_WV${attFile}"><spring:message code="psi_transport_receipt"/>Download</a>&nbsp;&nbsp;&nbsp;&nbsp;</c:when>
								<c:when test="${i.index eq 6 && attFile ne 'IS' }"><a href="${ctx}/psi/lcPsiTransportOrder/download?fileName=/${psiTransportOrder.transportNo}/${psiTransportOrder.transportNo}_IS${attFile}"><spring:message code="psi_transport_inspection"/> Download</a>&nbsp;&nbsp;&nbsp;&nbsp;</c:when>
								<c:when test="${i.index eq 7 && attFile ne 'CD' }"><a href="${ctx}/psi/lcPsiTransportOrder/download?fileName=/${psiTransportOrder.transportNo}/${psiTransportOrder.transportNo}_CD${attFile}"><spring:message code="psi_transport_declaration"/> Download</a>&nbsp;&nbsp;&nbsp;&nbsp;</c:when>
								<c:when test="${i.index eq 8 && attFile ne 'CS' }"><a href="${ctx}/psi/lcPsiTransportOrder/download?fileName=/${psiTransportOrder.transportNo}/${psiTransportOrder.transportNo}_CS${attFile}"><spring:message code="psi_transport_contract"/>-LC Download</a>&nbsp;&nbsp;&nbsp;&nbsp;</c:when>
								<c:when test="${i.index eq 9 && attFile ne 'SP' }"><a href="${ctx}/psi/lcPsiTransportOrder/download?fileName=/${psiTransportOrder.transportNo}/${psiTransportOrder.transportNo}_SP${attFile}"><spring:message code="psi_transport_insurance"/> Download</a>&nbsp;&nbsp;&nbsp;&nbsp;</c:when>
								<c:when test="${i.index eq 10 && attFile ne 'RS' }"><a href="${ctx}/psi/lcPsiTransportOrder/download?fileName=/${psiTransportOrder.transportNo}/${psiTransportOrder.transportNo}_RS${attFile}"><spring:message code="psi_transport_Telex"/> Download</a>&nbsp;&nbsp;&nbsp;&nbsp;</c:when>
								<c:when test="${i.index eq 11 && attFile ne 'AN' }"><a href="${ctx}/psi/lcPsiTransportOrder/download?fileName=/${psiTransportOrder.transportNo}/${psiTransportOrder.transportNo}_AN${attFile}"><spring:message code="psi_transport_arriveInvoice"/> Download</a>&nbsp;&nbsp;&nbsp;&nbsp;</c:when>
								<c:when test="${i.index eq 12 && attFile ne 'IB' }"><a href="${ctx}/psi/lcPsiTransportOrder/download?fileName=/${psiTransportOrder.transportNo}/${psiTransportOrder.transportNo}_IB${attFile}"><spring:message code="psi_transport_import"/> Download</a>&nbsp;&nbsp;&nbsp;&nbsp;</c:when>
							</c:choose>
						</c:otherwise>
				</c:choose>
			</c:forEach>   
			<c:if test="${not empty  psiTransportOrder.elsePath}">
				<c:forEach items="${fn:split(psiTransportOrder.elsePath,',')}" var="attFile" varStatus="i">
					<a href="${ctx}/psi/lcPsiTransportOrder/download?fileName=/${psiTransportOrder.transportNo}/other/${attFile}">Other_${i.index+1}</a>&nbsp;&nbsp;&nbsp;&nbsp;
				</c:forEach>
			</c:if>
			
			<c:if test="${not empty  psiTransportOrder.exportInvoicePath}">
					<a href="${ctx}/psi/lcPsiTransportOrder/download?fileName=/${psiTransportOrder.transportNo}/export/${psiTransportOrder.exportInvoicePath}"><%-- <spring:message code="psi_transport_export"/> --%>PI-LC Download </a>&nbsp;&nbsp;&nbsp;&nbsp;
			</c:if>
			<c:if test="${not empty psiTransportOrder.mixFile}">
			     <c:forEach items="${fn:split(psiTransportOrder.mixFile,'-')}" var="attFile" varStatus="i">
			           <c:choose>
							<c:when test="${fn:contains('.png,.pdf,.jpg,.JPG',attFile)}">
								<c:choose>    
									<c:when test="${i.index eq 0 && attFile ne 'BL_LC' }"><a target="_blank" href="<c:url value='/data/site/psi/psiTransport/${psiTransportOrder.transportNo}/${psiTransportOrder.transportNo}_BL_LC${attFile}'/>">BL-LC Download</a>&nbsp;&nbsp;&nbsp;&nbsp;</c:when>
									<c:when test="${i.index eq 1 && attFile ne 'PL_LC' }"><a target="_blank" href="<c:url value='/data/site/psi/psiTransport/${psiTransportOrder.transportNo}/${psiTransportOrder.transportNo}_PL_LC${attFile}'/>">PL-LC Download</a>&nbsp;&nbsp;&nbsp;&nbsp;</c:when>
									<c:when test="${i.index eq 2 && attFile ne 'SC_HK' }"><a target="_blank" href="<c:url value='/data/site/psi/psiTransport/${psiTransportOrder.transportNo}/${psiTransportOrder.transportNo}_SC_HK${attFile}'/>"><spring:message code="psi_transport_contract"/>-HK Download</a>&nbsp;&nbsp;&nbsp;&nbsp;</c:when>
								</c:choose>
							</c:when>
							<c:otherwise>
								<c:choose>
									<c:when test="${i.index eq 0 && attFile ne 'BL_LC' }"><a href="${ctx}/psi/lcPsiTransportOrder/download?fileName=/${psiTransportOrder.transportNo}/${psiTransportOrder.transportNo}_BL_LC${attFile}">BL-LC Download</a>&nbsp;&nbsp;&nbsp;&nbsp;</c:when>
									<c:when test="${i.index eq 1 && attFile ne 'PL_LC' }"><a href="${ctx}/psi/lcPsiTransportOrder/download?fileName=/${psiTransportOrder.transportNo}/${psiTransportOrder.transportNo}_PL_LC${attFile}">PL-LC Download</a>&nbsp;&nbsp;&nbsp;&nbsp;</c:when>
									<c:when test="${i.index eq 2 && attFile ne 'SC_HK' }"><a href="${ctx}/psi/lcPsiTransportOrder/download?fileName=/${psiTransportOrder.transportNo}/${psiTransportOrder.transportNo}_SC_HK${attFile}"><spring:message code="psi_transport_contract"/>-HK Download</a>&nbsp;&nbsp;&nbsp;&nbsp;</c:when>
								</c:choose>
							</c:otherwise>
				      </c:choose>
			     </c:forEach>
		...
		<thead>
			<tr>
				   ...
				   <shiro:hasAnyPermissions name="psi:transport:edit,psi:transport:costEdit">
					   <th style="width: 5%">CNPI Price(￥)</th>
					   <th style="width: 5%">PI Price</th>
		...
		<c:forEach items="${psiTransportOrder.items}"  var="item">
			<tr>
				...
				<td><input type="text" maxlength="11" style="width: 80%" readonly="readonly" value="${item.quantity/item.packQuantity}" /></td>
				 <shiro:hasAnyPermissions name="psi:transport:edit,psi:transport:costEdit">
					<td><input type="text" maxlength="11" style="width: 80%" readonly="readonly" value="${item.lowerPrice}" /></td>
					<td><input type="text" maxlength="11" style="width: 80%" readonly="readonly" value="${item.importPrice}" /></td>
				</shiro:hasAnyPermissions>
