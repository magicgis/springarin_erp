	...
	<form:form id="inputForm" modelAttribute="psiTransportOrder" action="${ctx}/psi/lcPsiTransportOrder/editSave" method="post" class="form-horizontal" enctype="multipart/form-data">
		...
		<div style="float:left;width:98%">
			...
			<div class="control-group" style="float:left;width:20%;height:25px">
					...
					<div class="controls" style="margin-left:100px" >
					<select name="currency1" class="currency"  style="width:95%"  ${fn:contains(canEditStr,'LocalAmount')||(fn:contains(canEditStr,'TranAmount')&&psiTransportOrder.model eq '2')?'disabled':''}>
						<option value=""></option>
			...
			<div class="control-group" style="float:left;width:15%;height:25px">
					...
					<div class="controls" style="margin-left:100px">
						<input  type="text" name="rate1" class="rate" maxlength="10" style="width:95%" ${fn:contains(canEditStr,'LocalAmount')||(fn:contains(canEditStr,'TranAmount')&&psiTransportOrder.model eq '2')?'readonly':''}  value="${psiTransportOrder.rate1}"/>
					</div>
			</div>
			<div class="control-group" style="float:left;width:15%;height:25px">
		...
		<div style="float:left;width:98%">
			...
			<div class="control-group" style="float:left;width:15%;height:25px">
					...
					<div class="controls" style="margin-left:100px" >
						<input  type="text" name="rate2" class="rate" maxlength="10" style="width:95%" ${fn:contains(canEditStr,'TranAmount')?'readonly':''}  value="${psiTransportOrder.rate2}"/>
					</div>
			</div>
			<div class="control-group" style="float:left;width:15%;height:25px">
		...
		<c:if test="${psiTransportOrder.model eq '0' }">
			<div style="float:left;width:98%">
				...
				<div class="control-group" style="float:left;width:15%;height:25px">
						...
						<div class="controls" style="margin-left:100px" >
							<input  type="text" name="rate3" class="rate" maxlength="10" ${fn:contains(canEditStr,'DapAmount')?'readonly':''} style="width:95%"  value="${psiTransportOrder.rate3}"/>
						</div>
				</div>
				<div class="control-group" style="float:left;width:15%;height:25px">
			...
			<div style="float:left;width:98%">
				<div class="control-group" style="float:left;width:30%;height:30px">
						...
						<div class="controls" style="margin-left:100px" >
							<input name="otherAmount" type="text"  ${fn:contains(canEditStr,'OtherAmount')?'readonly':''} maxlength="10" style="width:20%" class="price firstAmount" value="${psiTransportOrder.otherAmount}" id="otherAmount"/>
				...
				<div class="control-group" style="float:left;width:15%;height:25px">
						...
						<div class="controls" style="margin-left:100px" >
							<input  type="text" name="rate4" class="rate" maxlength="10" ${fn:contains(canEditStr,'OtherAmount')?'readonly':''} style="width:95%"  value="${psiTransportOrder.rate4}"/>
						</div>
				</div>
				<div class="control-group" style="float:left;width:15%;height:25px">
			...
			<div style="float:left;width:98%">
				...
				<div class="control-group" style="float:left;width:15%;height:25px">
						...
						<div class="controls" style="margin-left:100px" >
							<input  type="text" name="rate7" class="rate" maxlength="10" ${fn:contains(canEditStr,'OtherAmount1')?'readonly':''} style="width:95%"  value="${psiTransportOrder.rate7}"/>
						</div>
				</div>
				<div class="control-group" style="float:left;width:15%;height:25px">
			...
			<div style="float:left;width:98%">
				...
				<div class="control-group" style="float:left;width:20%;height:25px">
						...
						<div class="controls" style="margin-left:100px" >
							<select name="currency5" style="width:95%" class="currency"   ${fn:contains(canEditStr,'InsuranceAmount')?'disabled':''}>
							<option value="" ></option>
							<c:forEach items="${currencys}" var="currency">
		...
		<div style="float:left;width:98%">
			...
			<div class="control-group" style="float:left;width:20%;height:25px">
					...
					<div class="controls"  style="margin-left:100px">
						<select name="currency6" class="currency"  style="width:95%" ${fn:contains(canEditStr,'TaxAmount')?'disabled':''}>
						<option value=""></option>
						<c:forEach items="${currencys}" var="currency" >
		...
		<c:forEach items="${psiTransportOrder.items}"  var="item">
			<tr>
				...
				<td><input type='text' maxlength='11' style='width: 80%'  name='lowerPrice'  value="${item.lowerPrice}" class='lowerPrice' readonly/><input type="hidden" maxlength="11" style="width: 80%" name="productPrice" value="${item.productPrice}" class="productPrice" /></td>
				<td><input type='text' maxlength='11' style='width: 80%'  name='importPrice'  value="${item.importPrice}" class='importPrice' readonly/></td>
