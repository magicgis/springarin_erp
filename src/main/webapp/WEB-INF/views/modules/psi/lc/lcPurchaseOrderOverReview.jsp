...
<body>
	...
	<br/>
	<form:form id="inputForm" modelAttribute="purchaseOrder" action="${ctx}/psi/lcPurchaseOrder/reviewOverSave" method="post" class="form-horizontal" >
		...
		<div style="float:left;width:100%;display:inline;">
			...
			<div class="control-group" style="float:left;width:100%" >
				<label class="control-label"><b>超标现象</b>:</label>
				<div class="controls">
					<c:forEach items="${fn:split(purchaseOrder.overRemark,';')}" var="remark">
					${remark}<br/>
					</c:forEach>
				</div>
			</div>
			<div class="control-group" style="float:left;width:100%" >
				<label class="control-label"><b>特批原因</b>:</label>
				<div class="controls">
					<textarea name="overRemark"  rows="4" cols="4" maxlength="255" style="width:90%" required="required"  ></textarea>
				</div>
			</div>
