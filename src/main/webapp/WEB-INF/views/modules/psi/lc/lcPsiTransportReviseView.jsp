...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/psi/lcPsiTransportRevise/">运单付款修正列表</a></li>
		<li class="active"><a href="#">查看运单付款修正</a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="psiTransportRevise" action="${ctx}/psi/lcPsiTransportRevise/save" method="post" class="form-horizontal">
	   ...
	   <div style="float: left"><blockquote><p style="font-size: 14px">付款项信息</p></blockquote></div><div style="float: left" id=errorsShow></div>
		...
		<div style="${not empty psiTransportRevise.attchmentPath}">
			<blockquote style="float:left;width:98%;">
				<p style="font-size: 14px">水单凭证</p>
			</blockquote>
			
			<div class="control-group" style="float:left;width:98%;">
			<div class="controls">
				<div>
				<c:forEach items="${fn:split(psiTransportRevise.attchmentPath,',')}" var="attchment" varStatus="i">
					<a target="_blank" href="<c:url value='/data/site${attchment}'/>">查看水单凭证${i.index+1}</a>
					&nbsp;&nbsp;&nbsp;  
				</c:forEach>
				</div>
			</div>
