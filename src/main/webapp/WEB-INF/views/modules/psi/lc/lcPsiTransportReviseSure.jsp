		...
		$(document).ready(function() {
			...
			$("#inputForm").validate({
				submitHandler: function(form){
					if($(".totalAmount").val()>0&&$(".MultiFile-title").size()==0){
...
<body>
	...
	<form:form id="inputForm" modelAttribute="psiTransportRevise" action="${ctx}/psi/lcPsiTransportRevise/sureSave" method="post" class="form-horizontal" enctype="multipart/form-data">
	   ...
	   <div style="float: left"><blockquote><p style="font-size: 14px">付款项信息</p></blockquote></div><div style="float: left" id=errorsShow></div>
		...
		<div style="${psiTransportRevise.totalAmount<0 ?'display:none':''}">
			<blockquote style="float:left;width:98%;">
