	  ...
	  s.parentNode.insertBefore(hm, s);
		...
		$(document).ready(function() {
			...
			$("#export").click(function(){
				...
				window.location.href = "${ctx}/psi/lcPsiLadingBill/testCountSupplierExport?"+$.param(params);
...
<body>
    <ul class="nav nav-tabs">
    	...
    	<li class="active" ><a href="${ctx}/psi/lcPsiLadingBill/testCountSupplier">供应商合格率</a></li>
	</ul>
	<form:form id="searchForm" modelAttribute="lcPsiLadingBill" action="${ctx}/psi/lcPsiLadingBill/testCountSupplier" method="post" class="breadcrumb form-search" cssStyle="height: 30px;">
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<label>日期：</label>
	...
	<table id="dataTable" class="table table-bordered table-condensed">
		<thead><tr>
		<th width="5%">供应商</th><th width="5%">总批次</th><th width="5%">不合格批次</th><th width="5%">合格率</th></tr></thead>
		<tbody>
		<c:forEach items="${rateInfos}" var="obj" varStatus="i">
		<tr>
			<td>${supplierMap[obj[0]].nikename}</td>
			<td>${obj[1]}</td>
			<td>${obj[2]}</td>
			<td><fmt:formatNumber value="${obj[3]}" pattern="##.##"/></td>
		</tr>
		</c:forEach>
		</tbody>
	</table>
