...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="#">配件凭证上传</a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="partsDelivery" action="${ctx}/psi/lcPsiPartsDelivery/uploadSave" method="post" class="form-horizontal" enctype="multipart/form-data">
