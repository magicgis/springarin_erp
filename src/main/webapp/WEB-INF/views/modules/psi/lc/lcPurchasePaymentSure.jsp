		...
		$(document).ready(function() {
			...
			$("#inputForm").validate({
				submitHandler: function(form){
					if(parseFloat($(".curPaymentAmount").val())>parseFloat($(".canPaymentAmount").val())){
						top.$.jBox.tip("本次确认金额不能大于本次允许确认金额","info",{timeout:3000});
						return false;
					}
...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="#">确认采购付款</a></li>
		<li ><a href="${ctx}/psi/lcPurchaseOrder/moneyView">采购订单资金列表</a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="purchasePayment" action="${ctx}/psi/lcPurchasePayment/sureSave" method="post" class="form-horizontal" enctype="multipart/form-data" >
		...
		<div style="float:left;width:100%;">
			...
			<div class="control-group" style="float:left;width:35%">
				<label class="control-label" style="width:100px"><b>本次可确认金额</b>:</label>
				<div class="controls" style="margin-left:120px">
				<span>
		 	...
		 	<div class="control-group" style="float:left;width:28%">
				<label class="control-label" style="width:100px"><b>本次确认金额</b>:</label>
				<div class="controls" style="margin-left:120px">
				<span>
					<input type="text"  class="curPaymentAmount" name="curPaymentAmount" required="required"  value="${purchasePayment.canPaymentAmount}"/>
				</span>
				</div>
			</div>
		 </div>
