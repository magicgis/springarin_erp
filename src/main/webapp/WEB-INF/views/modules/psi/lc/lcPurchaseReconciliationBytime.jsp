		...
		$(document).ready(function() {
			...
			$("#exportCompare").click(function(){
				top.$.jBox.confirm("<spring:message code="sys_label_tips_export"/>","<spring:message code="sys_label_tips_msg"/>",function(v,h,f){
					if(v=="ok"){
						$("#searchForm").attr("action","${ctx}/psi/lcPurchaseOrder/reconciliationExport");
						$("#searchForm").submit();
						$("#searchForm").attr("action","${ctx}/psi/lcPurchaseOrder/reconciliation2");
					}
				},{buttonsFocus:1});
...
<body>
 <ul class="nav nav-tabs">
		<li ><a href="${ctx}/psi/lcPurchaseOrder/reconciliation">对账</a></li>
		<li class="active"><a href="${ctx}/psi/lcPurchaseOrder/reconciliation2">资金计划</a></li>
		<li ><a href="${ctx}/psi/lcPurchaseOrder/fReport">采购支付报表</a></li>
		<li ><a href="${ctx}/psi/lcPurchaseOrder/forecast">采购资金计划</a></li>
	</ul>
	<form:form id="searchForm" modelAttribute="purchaseOrder" action="${ctx}/psi/lcPurchaseOrder/reconciliation2" method="post" class="breadcrumb form-search" >
			<label>供应商：</label>
