...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/psi/lcPsiPartsInventoryOut/">配件出库列表</a></li>
	...
	<form:form id="inputForm" modelAttribute="lcPsiPartsInventoryOut" action="${ctx}/psi/lcPsiPartsInventoryOut/save" method="post" class="form-horizontal">
