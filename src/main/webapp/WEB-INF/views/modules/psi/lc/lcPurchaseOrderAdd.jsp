	...
	function jiaoji(str1, str2){
		...
		<c:forEach items="${products}" var="product" varStatus="i">
			...
			$("#supplier").on("change",function(e){
				...
				window.location.href = "${ctx}/psi/lcPurchaseOrder/add?"+$.param(params);
			});
...
<body>
	...
	<form:form id="inputForm" modelAttribute="purchaseOrder" action="${ctx}/psi/lcPurchaseOrder/addSave" method="post" class="form-horizontal">
