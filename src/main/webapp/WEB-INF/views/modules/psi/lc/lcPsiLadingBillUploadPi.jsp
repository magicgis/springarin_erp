...
<body>
	...
	<form:form id="inputForm" modelAttribute="psiLadingBill" action="${ctx}/psi/lcPsiLadingBill/uploadPiSave" method="post" class="form-horizontal" enctype="multipart/form-data">
