...
<body>
    <ul class="nav nav-tabs">
	     <shiro:hasPermission name="psi:purchaseOrder:accounts">
			<li class="active"><a href="${ctx}/psi/purchaseOrder/reconciliation">对账</a></li>
	...
	<form:form id="searchForm" modelAttribute="purchaseOrder" action="${ctx}/psi/purchaseOrder/reconciliation" method="post" class="breadcrumb form-search" cssStyle="height: 30px;">
	...
	<table id="dataTable" class="table table-bordered table-condensed">
		...
		<tr>
			<td>${i.index+1}</td>
			<td><a href="${ctx}/psi/purchaseOrder/lessCargoList?supplier.id=${purchaseOrder.supplier.id}">${purchaseOrder.supplier.nikename}</a></td>
			...
			<td><a class="btn btn-small" href="${ctx}/psi/purchaseOrder/lessCargoList?supplier.id=${purchaseOrder.supplier.id}">欠货明细</a>
			&nbsp;&nbsp;&nbsp;&nbsp;
			 <a class="btn btn-small" href="${ctx}/psi/psiLadingBill/receiptCargoList?supplier.id=${purchaseOrder.supplier.id}">收货明细</a>
		</tr>
		</c:forEach>
		</tbody>
		<tfoot>
