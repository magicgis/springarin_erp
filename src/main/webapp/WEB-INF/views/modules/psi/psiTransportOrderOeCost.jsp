...
<%@include file="/WEB-INF/views/include/dialog.jsp" %>
	...
	<body>
		<ul class="nav nav-tabs">
			...
			<li class="active"><a href="#">${empty psiTransportOrder.id ?'新建':'编辑'}海运运单</a></li>
		</ul><br/>
				...
				<div style="float:left;width:98%">
					<div class="control-group" style="float:left;width:25%;height:25px">
						...
						<div class="controls" style="margin-left:120px" >
							<select name="oceanModel" style="width: 100%" id="oceanModel"  ${(not empty canEditStr && 'OtherAmount,' ne canEditStr)?'disabled':''}>
	...
	<blockquote  style="float:left;width:98%;height:25px">
		...
		<div style="float:left;width:98%">
			...
			<div class="control-group" style="float:left;width:20%;height:25px">
					...
					<div class="controls" style="margin-left:100px" >
					<select name="currency1" style="width:95%" ${fn:contains(canEditStr,'LocalAmount')?'disabled':''}>
						<option value=""></option>
		...
		<div style="float:left;width:98%">
			...
			<div style="float:left;width:98%">
				<div class="control-group" style="float:left;width:30%;height:25px">
						...
						<div class="controls" style="margin-left:100px" >
							<input name="otherAmount" type="text"  maxlength="10" style="width:95%" ${fn:contains(canEditStr,'OtherAmount')?'readonly':''} class="price firstAmount" value="${psiTransportOrder.otherAmount}" id="otherAmount"/>
						</div>
				</div>
				<div class="control-group" style="float:left;width:20%;height:25px">
