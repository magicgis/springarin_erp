...
<body>
	...
	<form:form id="inputForm" modelAttribute="priceDto" action="" method="post" class="form-horizontal">
	    ...
	    <blockquote style="float:left;width:98%;">
			<p style="font-size: 15px;font-weight: bold">价格改动信息.</p>(本页面显示的都为CNY<span style='color:red'>不含税</span>税价)
		</blockquote>
	  	...
	  	<div style="float:left;width:100%">
			<div class="control-group" style="float:left;width:80%;">
				<div class="controls" style="margin-left:120px">
				<b>&nbsp;&nbsp;500档价格</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;改前:<b>
				<c:if test="${not empty priceDto.before500cny}"><fmt:formatNumber value="${priceDto.before500cny}"    pattern="0.##"/></c:if></b> &nbsp;&nbsp;>>>&nbsp;&nbsp;改后:<b>${priceDto.leval500cny}</b>
				</div>
			</div>
		</div>
	  	...
	  	<div style="float:left;width:100%">
			<div class="control-group" style="float:left;width:80%;">
				<div class="controls" style="margin-left:120px">
				<b>&nbsp;1000档价格</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;改前:<b>
				<c:if test="${not empty priceDto.before1000cny}"><fmt:formatNumber value="${priceDto.before1000cny}" pattern="0.##" /></c:if></b> &nbsp;&nbsp;>>>&nbsp;&nbsp;改后:<b>${priceDto.leval1000cny}</b>
				</div>
			</div>
		</div>
		...
		<div style="float:left;width:100%">
			<div class="control-group" style="float:left;width:80%;">
				<div class="controls" style="margin-left:120px">
				<b>&nbsp;2000档价格</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;改前:<b>
				<c:if test="${not empty priceDto.before2000cny}"><fmt:formatNumber value="${priceDto.before2000cny}" pattern="0.##" /></c:if></b> &nbsp;&nbsp;>>>&nbsp;&nbsp;改后:<b>${priceDto.leval2000cny}</b>
				</div>
			</div>
		</div>
		...
		<div style="float:left;width:100%">
			<div class="control-group" style="float:left;width:80%;">
				<div class="controls" style="margin-left:120px">
				<b>&nbsp;3000档价格</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;改前:<b>
				<c:if test="${not empty priceDto.before3000cny}"><fmt:formatNumber value="${priceDto.before3000cny}" pattern="0.##" /></c:if></b> &nbsp;&nbsp;>>>&nbsp;&nbsp;改后:<b>${priceDto.leval3000cny}</b>
				</div>
			</div>
		</div>
		...
		<div style="float:left;width:100%">
			<div class="control-group" style="float:left;width:80%;">
				<div class="controls" style="margin-left:120px">
				<b>&nbsp;5000档价格</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;改前:<b>
				<c:if test="${not empty priceDto.before5000cny}"><fmt:formatNumber value="${priceDto.before5000cny}" pattern="0.##" /></c:if></b> &nbsp;&nbsp;>>>&nbsp;&nbsp;改后:<b>${priceDto.leval5000cny}</b>
				</div>
			</div>
		</div>
		...
		<div style="float:left;width:100%">
			<div class="control-group" style="float:left;width:80%;">
				<div class="controls" style="margin-left:120px">
				<b>10000档价格</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;改前:<b>
				<c:if test="${not empty priceDto.before10000cny}"><fmt:formatNumber value="${priceDto.before10000cny}" pattern="0.##" /></c:if>
				</b> &nbsp;&nbsp;>>>&nbsp;&nbsp;改后:<b>${priceDto.leval10000cny}</b>
				</div>
			</div>
		</div>
		...
		<div style="float:left;width:100%">
			<div class="control-group" style="float:left;width:80%;">
				<div class="controls" style="margin-left:120px">
				<b>15000档价格</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;改前:<b>
				<c:if test="${not empty priceDto.before15000cny}"><fmt:formatNumber value="${priceDto.before15000cny}" pattern="0.##" /></c:if></b> &nbsp;&nbsp;>>>&nbsp;&nbsp;改后:<b>${priceDto.leval15000cny}</b>
				</div>
			</div>
		</div>
