	  ...
	  s.parentNode.insertBefore(hm, s);
		...
		$(document).ready(function() {
			...
			$("#supplier").on("change",function(e){
				...
				window.location.href = "${ctx}/psi/psiPartsOrder/add?"+$.param(params);
			});
...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="#">增加配件</a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="psiPartsOrder" action="${ctx}/psi/psiPartsOrder/addSave" method="post" class="form-horizontal">
		 <blockquote>
