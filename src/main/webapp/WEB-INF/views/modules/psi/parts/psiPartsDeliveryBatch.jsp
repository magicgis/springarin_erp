...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/psi/psiPartsDelivery/">配件收货单列表</a></li>
		<li class="active"><a href="#">创建配件收货单</a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="psiPartsDelivery" action="${ctx}/psi/psiPartsDelivery/save" method="post" class="form-horizontal">
