...
<body>
	...
	<form:form id="inputForm" modelAttribute="psiPartsPayment" action="${ctx}/psi/psiPartsPayment/sureSave" method="post" class="form-horizontal" enctype="multipart/form-data"  >
