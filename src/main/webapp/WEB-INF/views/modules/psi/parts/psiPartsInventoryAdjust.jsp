...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="#">配件库存调整</a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="psiPartsInventory" action="${ctx}/psi/psiPartsInventory/adjustSave" method="post" class="form-horizontal">
