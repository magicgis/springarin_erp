	...
	(function() {
	  ...
	  s.parentNode.insertBefore(hm, s);
		...
		function goEdit(orderId){
			var params = {};
			params.id = orderId;
			window.location.href = "${ctx}/psi/purchaseOrder/edit?"+$.param(params);
		}
...
<body>
	...
	<br/>
	<form:form id="inputForm" modelAttribute="purchaseOrder" action="${ctx}/psi/purchaseOrder/uploadPiSave" method="post" class="form-horizontal" enctype="multipart/form-data" >
