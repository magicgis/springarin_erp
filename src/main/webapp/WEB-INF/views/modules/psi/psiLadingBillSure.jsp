				...
				if(ladingArrays.length>0){
					for(var i=0;i<ladingArrays.length;i++){
						...
						if(skuMap[key]){
							...
							if(i==0){
								var tr = $("<tr></tr>");
					            tr.append("<td style='text-align:center'> <input type='text' readOnly style='width:200px' name='productConName'/><input type='hidden' name='id'/><input type='hidden' name='isPass'/>"+
					            ...
					            tr.append("<td><input type='hidden' class='canSureQuantity'/> <input style='width: 90%' type='text' name='quantitySureTemp' /></td>");
					            ...
					            tr.append("<td> <input type='text' style='width: 90%' name='quantityOffLading' readonly /></td>");
					            tr.append("<td> <input type='text' style='width: 90%' name='quantitySure' readonly /></td>");
					            tr.append("<td><input type='hidden' class='canSureQuantity'/> <input type='text' style='width: 90%' name='quantitySureTemp' /></td>");
							...
							var tr = $("<tr></tr>");
					            ...
					            tr.append("<td> <input style='width: 90%' type='text' name='quantitySureTemp' /></td>");
					            tr.append("<td> <input style='width: 90%' type='text' name='remark' /></td>");
...
<body>
	...
	<form:form id="inputForm" modelAttribute="psiLadingBill" action="${ctx}/psi/psiLadingBill/sureSave" method="post" class="form-horizontal" enctype="multipart/form-data">
	    ...
	    <div  class="alert alert-info"><strong>Tips:实际收货日期对于财务对账来说很重要，请根据供应商实际送货日期进行填写！</strong></div>
	    <blockquote>
			...
			<div class="control-group"  style="float:left;width:33%" >
				...
				<div class="controls" >
				<span>
					<input type="text" name="actualDeliveryDate" class="Wdate required" value="" />
				</span>
				</div>
			</div>
		</div>
