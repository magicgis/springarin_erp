	...
	<script type="text/javascript">
		...
		$(document).ready(function() {
			$("#btnSubmit").click(function(){
				$("#searchForm").attr("action","${ctx}/psi/psiTransportPayment/exportOffLineTransport");
				$("#searchForm").submit();
				$("#searchForm").attr("action","${ctx}/psi/psiTransportPayment/byMonthTransportOffLine");
			});
...
<body>
   <ul class="nav nav-tabs">
	  ...
	  <li  class="active"><a href="${ctx}/psi/psiTransportPayment/byMonthTransportOffLine">线下运输分析</a></li>
	...
	<form id="searchForm" action="${ctx}/psi/psiTransportPayment/byMonthTransportOffLine" method="post"  class="breadcrumb form-search" cssStyle="height: 80px;">
	   &nbsp;&nbsp;&nbsp;&nbsp;统计时间:
