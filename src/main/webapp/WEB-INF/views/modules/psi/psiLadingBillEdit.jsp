						...
						if(i==0){
				        	...
				        	for(var j=0;j<ccc.length;j++){
								if(ccc[j][3]==ladingDto.purchaseOrderItemId){
								    ...
								    var hrefs="${ctx}/psi/purchaseOrder/view?id="+ccc[j][5];   
...
<body>
	...
	<form:form id="inputForm" modelAttribute="psiLadingBill" action="${ctx}/psi/psiLadingBill/editSave" method="post" class="form-horizontal">
