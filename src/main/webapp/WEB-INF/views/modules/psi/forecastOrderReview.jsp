	  ...
	  s.parentNode.insertBefore(hm, s);
		...
		$(document).ready(function() {
			...
			$("#isCheck,#isMain,#isNew,#isPriceChange,#lineId,#nameColor,#country").on("change",function(){
				...
				window.location.href="${ctx}/psi/forecastOrder/review?"+$.param(params);
			});
			...
			$("#btnSubmit").on("click",function(){
				top.$.jBox.confirm('您确定要审核通过','系统提示',function(v,h,f){
					if(v=='ok'){
					     window.location.href="${ctx}/psi/forecastOrder/reviewSave?id="+$("#forecastOrderId").val();
					}
				});
			});
		...
		function goRefresh(){
			...
			window.location.href="${ctx}/psi/forecastOrder/review?id="+id+"&country="+country+"&nameColor="+nameColor+"&isCheck="+isCheck;
		}
	</script>
</head>
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="#">预测下单审核</a></li>
	</ul>
