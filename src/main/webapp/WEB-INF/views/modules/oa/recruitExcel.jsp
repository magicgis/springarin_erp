...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/oa/recruit/excel">招聘excel导入</a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="recruit" action="${ctx}/oa/recruit/excelSave" method="post" class="form-horizontal" enctype="multipart/form-data">
