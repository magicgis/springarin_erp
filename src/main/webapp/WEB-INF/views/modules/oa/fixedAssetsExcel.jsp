...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/oa/fixedAssets/excel">固定资产excel导入</a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="fixedAssets" action="${ctx}/oa/fixedAssets/excelSave" method="post" class="form-horizontal" enctype="multipart/form-data">
