...
<body>
	...
	<form:form id="inputForm" modelAttribute="role" action="${ctx}/sys/role/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			<label class="control-label">角色标示:</label>
			<div class="controls">
		...
		<div class="control-group">
			...
			<div class="controls">
				<select name="type" class="required" id="type">
					<option value="1" ${'1' eq role.type?'selected':''}>岗位</option>
					<option value="0" ${'0' eq role.type?'selected':''}>普通角色</option>
					<option value="2" ${'2' eq role.type?'selected':''} >特殊角色</option>
				</select>
			</div>
		</div>
		<div class="control-group">
