...
<body>
	...
	<form id="listForm" method="post">
		<table id="treeTable" class="table table-striped table-bordered table-condensed">
			<tr><th>名称</th><th>链接</th><th>使用范围</th><th style="text-align:center;">排序</th><th>可见</th><th>权限标识</th><shiro:hasPermission name="sys:menu:edit"><th>操作</th></shiro:hasPermission></tr>
			<c:forEach items="${list}" var="menu">
				<tr id="${menu.id}" pId="${menu.parent.id ne '1' ? menu.parent.id : '0'}">
					<td><i class="icon-${not empty menu.icon?menu.icon:' hide'}"></i><a href="${ctx}/sys/menu/form?id=${menu.id}">${menu.messageName}</a></td>
					<td>${menu.href}</td>
					<td>
						<a href="#" style="color: #08c;" data-toggle="popover" data-html="true" data-placement="left" rel="popover" 
							data-content="1:国外服务器,2:本地服务器,3:美国新服务器,4:美国Tomons服务器">
							${menu.remarks}
						</a>
					</td>
					...
					<td>
						<a rel="popover" data-content="${menu.roleNames}">${menu.isShow eq '1'?'显示':'隐藏'}</a>
					</td>
