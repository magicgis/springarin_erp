...
<body>
	...
	<form:form id="inputForm" modelAttribute="user" action="${ctx}/sys/user/info" method="post" class="form-horizontal">
		...
		<div class="control-group">
			<label class="control-label">默认菜单:</label>
			<div class="controls">
                <tags:treeselect id="firstMenu" name="firstMenu.id" value="${user.firstMenu.id}" labelName="firstMenu.name" labelValue="${user.firstMenu.name}"
					title="默认菜单" url="/sys/user/treeData"/>
			</div>
		</div>
		<div class="control-group">
