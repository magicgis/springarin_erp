...
<script src="${ctxStatic}/common/bootstrap-progressbar.js" type="text/javascript"></script>
<link rel="shortcut icon" href="${ctxStatic}/favicon.ico">

<script src="${ctxStatic}/common/bootstrap-progressbar.js" type="text/javascript"></script>

<link href="${ctxStatic}/bootstrap-switch-master/dist/css/bootstrap2/bootstrap-switch.min.css" type="text/css" rel="stylesheet" />
<script src="${ctxStatic}/bootstrap-switch-master/dist/js/bootstrap-switch.min.js" type="text/javascript"></script>
